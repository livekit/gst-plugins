...
type AvencAdpcmImaWav struct {
	Element *gst.Element
}

func NewAvencAdpcmImaWav() (*AvencAdpcmImaWav, error) {
	e, err := gst.NewElement("avenc_adpcm_ima_wav")
	if err != nil {
		return nil, err
	}
	return &AvencAdpcmImaWav{Element: e}, nil
}

func NewAvencAdpcmImaWavWithName(name string) (*AvencAdpcmImaWav, error) {
	e, err := gst.NewElementWithName("avenc_adpcm_ima_wav", name)
	if err != nil {
		return nil, err
	}
	return &AvencAdpcmImaWav{Element: e}, nil
...
func (e *AvencAdpcmImaWav) GetAc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaWav) SetAc(value int) error {
...
func (e *AvencAdpcmImaWav) GetAr() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaWav) SetAr(value int) error {
...
func (e *AvencAdpcmImaWav) GetAudioServiceType() (interface{}, error) {
	return e.Element.GetProperty("audio-service-type")
}

func (e *AvencAdpcmImaWav) SetAudioServiceType(value interface{}) error {
...
func (e *AvencAdpcmImaWav) GetBitrate() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaWav) SetBitrate(value int) error {
...
func (e *AvencAdpcmImaWav) GetBlockSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaWav) SetBlockSize(value int) error {
...
func (e *AvencAdpcmImaWav) GetBufsize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaWav) SetBufsize(value int) error {
...
func (e *AvencAdpcmImaWav) GetChannelLayout() (uint64, error) {
	var value uint64
	var ok bool
...
func (e *AvencAdpcmImaWav) SetChannelLayout(value uint64) error {
...
func (e *AvencAdpcmImaWav) GetCompressionLevel() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaWav) SetCompressionLevel(value int) error {
...
func (e *AvencAdpcmImaWav) GetCutoff() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaWav) SetCutoff(value int) error {
...
func (e *AvencAdpcmImaWav) GetDebug() (interface{}, error) {
	return e.Element.GetProperty("debug")
}

func (e *AvencAdpcmImaWav) SetDebug(value interface{}) error {
...
func (e *AvencAdpcmImaWav) GetDumpSeparator() (string, error) {
	var value string
	var ok bool
...
func (e *AvencAdpcmImaWav) SetDumpSeparator(value string) error {
...
func (e *AvencAdpcmImaWav) GetErrDetect() (interface{}, error) {
	return e.Element.GetProperty("err-detect")
}

func (e *AvencAdpcmImaWav) SetErrDetect(value interface{}) error {
...
func (e *AvencAdpcmImaWav) GetExportSideData() (interface{}, error) {
	return e.Element.GetProperty("export-side-data")
}

func (e *AvencAdpcmImaWav) SetExportSideData(value interface{}) error {
...
func (e *AvencAdpcmImaWav) GetFlags() (interface{}, error) {
	return e.Element.GetProperty("flags")
}

func (e *AvencAdpcmImaWav) SetFlags(value interface{}) error {
...
func (e *AvencAdpcmImaWav) GetFlags2() (interface{}, error) {
	return e.Element.GetProperty("flags2")
}

func (e *AvencAdpcmImaWav) SetFlags2(value interface{}) error {
...
func (e *AvencAdpcmImaWav) GetFrameSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaWav) SetFrameSize(value int) error {
...
func (e *AvencAdpcmImaWav) GetGlobalQuality() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaWav) SetGlobalQuality(value int) error {
...
func (e *AvencAdpcmImaWav) GetMaxPixels() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAdpcmImaWav) SetMaxPixels(value int64) error {
...
func (e *AvencAdpcmImaWav) GetMaxPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaWav) SetMaxPredictionOrder(value int) error {
...
func (e *AvencAdpcmImaWav) GetMaxSamples() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAdpcmImaWav) SetMaxSamples(value int64) error {
...
func (e *AvencAdpcmImaWav) GetMaxrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAdpcmImaWav) SetMaxrate(value int64) error {
...
func (e *AvencAdpcmImaWav) GetMinPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaWav) SetMinPredictionOrder(value int) error {
...
func (e *AvencAdpcmImaWav) GetMinrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAdpcmImaWav) SetMinrate(value int64) error {
...
func (e *AvencAdpcmImaWav) GetSideDataOnlyPackets() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencAdpcmImaWav) SetSideDataOnlyPackets(value bool) error {
...
func (e *AvencAdpcmImaWav) GetStrict() (interface{}, error) {
	return e.Element.GetProperty("strict")
}

func (e *AvencAdpcmImaWav) SetStrict(value interface{}) error {
...
func (e *AvencAdpcmImaWav) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvencAdpcmImaWav) SetThreadType(value interface{}) error {
...
func (e *AvencAdpcmImaWav) GetThreads() (interface{}, error) {
	return e.Element.GetProperty("threads")
}

func (e *AvencAdpcmImaWav) SetThreads(value interface{}) error {
...
func (e *AvencAdpcmImaWav) GetTicksPerFrame() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaWav) SetTicksPerFrame(value int) error {
...
func (e *AvencAdpcmImaWav) GetTrellis() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaWav) SetTrellis(value int) error {
