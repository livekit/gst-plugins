...
type AvencVc2 struct {
	Element *gst.Element
}

func NewAvencVc2() (*AvencVc2, error) {
	e, err := gst.NewElement("avenc_vc2")
	if err != nil {
		return nil, err
	}
	return &AvencVc2{Element: e}, nil
}

func NewAvencVc2WithName(name string) (*AvencVc2, error) {
	e, err := gst.NewElementWithName("avenc_vc2", name)
	if err != nil {
		return nil, err
	}
	return &AvencVc2{Element: e}, nil
...
func (e *AvencVc2) GetBQfactor() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencVc2) SetBQfactor(value float32) error {
...
func (e *AvencVc2) GetBQoffset() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencVc2) SetBQoffset(value float32) error {
...
func (e *AvencVc2) GetBSensitivity() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetBSensitivity(value int) error {
...
func (e *AvencVc2) GetBStrategy() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetBStrategy(value int) error {
...
func (e *AvencVc2) GetBidirRefine() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetBidirRefine(value int) error {
...
func (e *AvencVc2) GetBitrate() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetBitrate(value int) error {
...
func (e *AvencVc2) GetBitrateTolerance() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetBitrateTolerance(value int) error {
...
func (e *AvencVc2) GetBrdScale() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetBrdScale(value int) error {
...
func (e *AvencVc2) GetBufsize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetBufsize(value int) error {
...
func (e *AvencVc2) GetChromaSampleLocation() (interface{}, error) {
	return e.Element.GetProperty("chroma-sample-location")
}

func (e *AvencVc2) SetChromaSampleLocation(value interface{}) error {
...
func (e *AvencVc2) GetChromaoffset() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetChromaoffset(value int) error {
...
func (e *AvencVc2) GetCmp() (interface{}, error) {
	return e.Element.GetProperty("cmp")
}

func (e *AvencVc2) SetCmp(value interface{}) error {
...
func (e *AvencVc2) GetCoder() (interface{}, error) {
	return e.Element.GetProperty("coder")
}

func (e *AvencVc2) SetCoder(value interface{}) error {
...
func (e *AvencVc2) GetCompressionLevel() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetCompressionLevel(value int) error {
...
func (e *AvencVc2) GetContext() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetContext(value int) error {
...
func (e *AvencVc2) GetDarkMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencVc2) SetDarkMask(value float32) error {
...
func (e *AvencVc2) GetDc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetDc(value int) error {
...
func (e *AvencVc2) GetDct() (interface{}, error) {
	return e.Element.GetProperty("dct")
}

func (e *AvencVc2) SetDct(value interface{}) error {
...
func (e *AvencVc2) GetDebug() (interface{}, error) {
	return e.Element.GetProperty("debug")
}

func (e *AvencVc2) SetDebug(value interface{}) error {
...
func (e *AvencVc2) GetDiaSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetDiaSize(value int) error {
...
func (e *AvencVc2) GetDumpSeparator() (string, error) {
	var value string
	var ok bool
...
func (e *AvencVc2) SetDumpSeparator(value string) error {
...
func (e *AvencVc2) GetErrDetect() (interface{}, error) {
	return e.Element.GetProperty("err-detect")
}

func (e *AvencVc2) SetErrDetect(value interface{}) error {
...
func (e *AvencVc2) GetExportSideData() (interface{}, error) {
	return e.Element.GetProperty("export-side-data")
}

func (e *AvencVc2) SetExportSideData(value interface{}) error {
...
func (e *AvencVc2) GetFieldOrder() (interface{}, error) {
	return e.Element.GetProperty("field-order")
}

func (e *AvencVc2) SetFieldOrder(value interface{}) error {
...
func (e *AvencVc2) GetFlags() (interface{}, error) {
	return e.Element.GetProperty("flags")
}

func (e *AvencVc2) SetFlags(value interface{}) error {
...
func (e *AvencVc2) GetFlags2() (interface{}, error) {
	return e.Element.GetProperty("flags2")
}

func (e *AvencVc2) SetFlags2(value interface{}) error {
...
func (e *AvencVc2) GetGlobalQuality() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetGlobalQuality(value int) error {
...
func (e *AvencVc2) GetGopSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetGopSize(value int) error {
...
func (e *AvencVc2) GetIQfactor() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencVc2) SetIQfactor(value float32) error {
...
func (e *AvencVc2) GetIQoffset() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencVc2) SetIQoffset(value float32) error {
...
func (e *AvencVc2) GetIdct() (interface{}, error) {
	return e.Element.GetProperty("idct")
}

func (e *AvencVc2) SetIdct(value interface{}) error {
...
func (e *AvencVc2) GetIldctcmp() (interface{}, error) {
	return e.Element.GetProperty("ildctcmp")
}

func (e *AvencVc2) SetIldctcmp(value interface{}) error {
...
func (e *AvencVc2) GetKeyintMin() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetKeyintMin(value int) error {
...
func (e *AvencVc2) GetLastPred() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetLastPred(value int) error {
...
func (e *AvencVc2) GetLumiMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencVc2) SetLumiMask(value float32) error {
...
func (e *AvencVc2) GetMaxBframes() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetMaxBframes(value int) error {
...
func (e *AvencVc2) GetMaxPixels() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencVc2) SetMaxPixels(value int64) error {
...
func (e *AvencVc2) GetMaxrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencVc2) SetMaxrate(value int64) error {
...
func (e *AvencVc2) GetMbcmp() (interface{}, error) {
	return e.Element.GetProperty("mbcmp")
}

func (e *AvencVc2) SetMbcmp(value interface{}) error {
...
func (e *AvencVc2) GetMbd() (interface{}, error) {
	return e.Element.GetProperty("mbd")
}

func (e *AvencVc2) SetMbd(value interface{}) error {
...
func (e *AvencVc2) GetMblmax() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetMblmax(value int) error {
...
func (e *AvencVc2) GetMblmin() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetMblmin(value int) error {
...
func (e *AvencVc2) GetMeRange() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetMeRange(value int) error {
...
func (e *AvencVc2) GetMepc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetMepc(value int) error {
...
func (e *AvencVc2) GetMinrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencVc2) SetMinrate(value int64) error {
...
func (e *AvencVc2) GetMpegQuant() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetMpegQuant(value int) error {
...
func (e *AvencVc2) GetMultipassCacheFile() (string, error) {
	var value string
	var ok bool
...
func (e *AvencVc2) SetMultipassCacheFile(value string) error {
...
func (e *AvencVc2) GetMv0Threshold() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetMv0Threshold(value int) error {
...
func (e *AvencVc2) GetNr() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetNr(value int) error {
...
func (e *AvencVc2) GetNssew() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetNssew(value int) error {
...
func (e *AvencVc2) GetPMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencVc2) SetPMask(value float32) error {
...
func (e *AvencVc2) GetPass() (interface{}, error) {
	return e.Element.GetProperty("pass")
}

func (e *AvencVc2) SetPass(value interface{}) error {
...
func (e *AvencVc2) GetPreDiaSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetPreDiaSize(value int) error {
...
func (e *AvencVc2) GetPrecmp() (interface{}, error) {
	return e.Element.GetProperty("precmp")
}

func (e *AvencVc2) SetPrecmp(value interface{}) error {
...
func (e *AvencVc2) GetPred() (interface{}, error) {
	return e.Element.GetProperty("pred")
}

func (e *AvencVc2) SetPred(value interface{}) error {
...
func (e *AvencVc2) GetPreme() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetPreme(value int) error {
...
func (e *AvencVc2) GetPs() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetPs(value int) error {
...
func (e *AvencVc2) GetQblur() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencVc2) SetQblur(value float32) error {
...
func (e *AvencVc2) GetQcomp() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencVc2) SetQcomp(value float32) error {
...
func (e *AvencVc2) GetQdiff() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetQdiff(value int) error {
	return e.Element.SetProperty("qdiff", value)
}

// qm (GstSmpteVc2EncoderQuantMatrix)
//
// Custom quantization matrix (Private codec option)

func (e *AvencVc2) GetQm() (interface{}, error) {
	return e.Element.GetProperty("qm")
}

func (e *AvencVc2) SetQm(value interface{}) error {
	return e.Element.SetProperty("qm", value)
}
...
func (e *AvencVc2) GetQmax() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetQmax(value int) error {
...
func (e *AvencVc2) GetQmin() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetQmin(value int) error {
...
func (e *AvencVc2) GetQuantizer() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencVc2) SetQuantizer(value float32) error {
...
func (e *AvencVc2) GetRcInitOccupancy() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetRcInitOccupancy(value int) error {
...
func (e *AvencVc2) GetRcMaxVbvUse() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencVc2) SetRcMaxVbvUse(value float32) error {
...
func (e *AvencVc2) GetRcMinVbvUse() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencVc2) SetRcMinVbvUse(value float32) error {
...
func (e *AvencVc2) GetRefs() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetRefs(value int) error {
...
func (e *AvencVc2) GetScThreshold() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetScThreshold(value int) error {
...
func (e *AvencVc2) GetScplxMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencVc2) SetScplxMask(value float32) error {
...
func (e *AvencVc2) GetSideDataOnlyPackets() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencVc2) SetSideDataOnlyPackets(value bool) error {
...
func (e *AvencVc2) GetSkipExp() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetSkipExp(value int) error {
...
func (e *AvencVc2) GetSkipFactor() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetSkipFactor(value int) error {
...
func (e *AvencVc2) GetSkipThreshold() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetSkipThreshold(value int) error {
...
func (e *AvencVc2) GetSkipcmp() (interface{}, error) {
	return e.Element.GetProperty("skipcmp")
}

func (e *AvencVc2) SetSkipcmp(value interface{}) error {
	return e.Element.SetProperty("skipcmp", value)
}

// slice-height (int)
//
// Slice height (Private codec option)

func (e *AvencVc2) GetSliceHeight() (int, error) {
	var value int
	var ok bool
	v, err := e.Element.GetProperty("slice-height")
	if err != nil {
		return value, err
	}
	value, ok = v.(int)
...
func (e *AvencVc2) SetSliceHeight(value int) error {
	return e.Element.SetProperty("slice-height", value)
}

// slice-width (int)
//
// Slice width (Private codec option)

func (e *AvencVc2) GetSliceWidth() (int, error) {
	var value int
	var ok bool
	v, err := e.Element.GetProperty("slice-width")
	if err != nil {
		return value, err
	}
	value, ok = v.(int)
...
func (e *AvencVc2) SetSliceWidth(value int) error {
	return e.Element.SetProperty("slice-width", value)
}
...
func (e *AvencVc2) GetSlices() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetSlices(value int) error {
...
func (e *AvencVc2) GetStrict() (interface{}, error) {
	return e.Element.GetProperty("strict")
}

func (e *AvencVc2) SetStrict(value interface{}) error {
...
func (e *AvencVc2) GetSubcmp() (interface{}, error) {
	return e.Element.GetProperty("subcmp")
}

func (e *AvencVc2) SetSubcmp(value interface{}) error {
...
func (e *AvencVc2) GetSubq() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetSubq(value int) error {
...
func (e *AvencVc2) GetTcplxMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencVc2) SetTcplxMask(value float32) error {
...
func (e *AvencVc2) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvencVc2) SetThreadType(value interface{}) error {
...
func (e *AvencVc2) GetThreads() (interface{}, error) {
	return e.Element.GetProperty("threads")
}

func (e *AvencVc2) SetThreads(value interface{}) error {
...
func (e *AvencVc2) GetTicksPerFrame() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetTicksPerFrame(value int) error {
...
func (e *AvencVc2) GetTimecodeFrameStart() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencVc2) SetTimecodeFrameStart(value int64) error {
	return e.Element.SetProperty("timecode-frame-start", value)
}

// tolerance (float64)
//
// Max undershoot in percent (Private codec option)

func (e *AvencVc2) GetTolerance() (float64, error) {
	var value float64
	var ok bool
...
func (e *AvencVc2) SetTolerance(value float64) error {
...
func (e *AvencVc2) GetTrellis() (int, error) {
	var value int
	var ok bool
...
func (e *AvencVc2) SetTrellis(value int) error {
	return e.Element.SetProperty("trellis", value)
}

// wavelet-depth (int)
//
// Transform depth (Private codec option)

func (e *AvencVc2) GetWaveletDepth() (int, error) {
	var value int
	var ok bool
	v, err := e.Element.GetProperty("wavelet-depth")
	if err != nil {
		return value, err
	}
	value, ok = v.(int)
...
func (e *AvencVc2) SetWaveletDepth(value int) error {
	return e.Element.SetProperty("wavelet-depth", value)
}

// wavelet-type (GstSmpteVc2EncoderWaveletIdx)
//
// Transform type (Private codec option)

func (e *AvencVc2) GetWaveletType() (interface{}, error) {
	return e.Element.GetProperty("wavelet-type")
}

func (e *AvencVc2) SetWaveletType(value interface{}) error {
	return e.Element.SetProperty("wavelet-type", value)
}

// ----- Constants -----

type SmpteVc2EncoderQuantMatrix string

const (
	SmpteVc2EncoderQuantMatrixDefault SmpteVc2EncoderQuantMatrix = "default" // default (0) – Default from the specifications
	SmpteVc2EncoderQuantMatrixColor SmpteVc2EncoderQuantMatrix = "color" // color (1) – Prevents low bitrate discoloration
	SmpteVc2EncoderQuantMatrixFlat SmpteVc2EncoderQuantMatrix = "flat" // flat (2) – Optimize for PSNR
)

type SmpteVc2EncoderWaveletIdx string

const (
	SmpteVc2EncoderWaveletIdx97 SmpteVc2EncoderWaveletIdx = "9_7" // 9_7 (0) – Deslauriers-Dubuc (9,7)
	SmpteVc2EncoderWaveletIdx53 SmpteVc2EncoderWaveletIdx = "5_3" // 5_3 (1) – LeGall (5,3)
	SmpteVc2EncoderWaveletIdxHaarNoshift SmpteVc2EncoderWaveletIdx = "haar_noshift" // haar_noshift (3) – Haar (without shift)
	SmpteVc2EncoderWaveletIdxHaar SmpteVc2EncoderWaveletIdx = "haar" // haar (4) – Haar (with shift)
)
