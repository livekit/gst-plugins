...
type AvdecExr struct {
	Element *gst.Element
}

func NewAvdecExr() (*AvdecExr, error) {
	e, err := gst.NewElement("avdec_exr")
	if err != nil {
		return nil, err
	}
	return &AvdecExr{Element: e}, nil
}

func NewAvdecExrWithName(name string) (*AvdecExr, error) {
	e, err := gst.NewElementWithName("avdec_exr", name)
	if err != nil {
		return nil, err
	}
	return &AvdecExr{Element: e}, nil
...
func (e *AvdecExr) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecExr) SetDebugMv(value bool) error {
...
func (e *AvdecExr) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecExr) SetDirectRendering(value bool) error {
...
func (e *AvdecExr) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecExr) SetLowres(value interface{}) error {
...
func (e *AvdecExr) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecExr) SetMaxThreads(value int) error {
...
func (e *AvdecExr) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecExr) SetOutputCorrupt(value bool) error {
...
func (e *AvdecExr) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecExr) SetSkipFrame(value interface{}) error {
...
func (e *AvdecExr) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecExr) SetThreadType(value interface{}) error {
