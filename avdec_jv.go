...
func NewAvdecJv() (*AvdecJv, error) {
	e, err := gst.NewElement("avdec_jv")
	if err != nil {
		return nil, err
	}
	return &AvdecJv{Element: e}, nil
}

func NewAvdecJvWithName(name string) (*AvdecJv, error) {
	e, err := gst.NewElementWithName("avdec_jv", name)
	if err != nil {
		return nil, err
	}
	return &AvdecJv{Element: e}, nil
...
func (e *AvdecJv) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecJv) SetDebugMv(value bool) error {
...
func (e *AvdecJv) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecJv) SetDirectRendering(value bool) error {
...
func (e *AvdecJv) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecJv) SetLowres(value interface{}) error {
...
func (e *AvdecJv) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecJv) SetOutputCorrupt(value bool) error {
...
func (e *AvdecJv) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecJv) SetSkipFrame(value interface{}) error {
