...
type AvencAlac struct {
	Element *gst.Element
}

func NewAvencAlac() (*AvencAlac, error) {
	e, err := gst.NewElement("avenc_alac")
	if err != nil {
		return nil, err
	}
	return &AvencAlac{Element: e}, nil
}

func NewAvencAlacWithName(name string) (*AvencAlac, error) {
	e, err := gst.NewElementWithName("avenc_alac", name)
	if err != nil {
		return nil, err
	}
	return &AvencAlac{Element: e}, nil
...
func (e *AvencAlac) GetAc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAlac) SetAc(value int) error {
...
func (e *AvencAlac) GetAr() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAlac) SetAr(value int) error {
...
func (e *AvencAlac) GetAudioServiceType() (interface{}, error) {
	return e.Element.GetProperty("audio-service-type")
}

func (e *AvencAlac) SetAudioServiceType(value interface{}) error {
...
func (e *AvencAlac) GetBitrate() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAlac) SetBitrate(value int) error {
...
func (e *AvencAlac) GetBufsize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAlac) SetBufsize(value int) error {
...
func (e *AvencAlac) GetChannelLayout() (uint64, error) {
	var value uint64
	var ok bool
...
func (e *AvencAlac) SetChannelLayout(value uint64) error {
...
func (e *AvencAlac) GetCompressionLevel() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAlac) SetCompressionLevel(value int) error {
...
func (e *AvencAlac) GetCutoff() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAlac) SetCutoff(value int) error {
...
func (e *AvencAlac) GetDebug() (interface{}, error) {
	return e.Element.GetProperty("debug")
}

func (e *AvencAlac) SetDebug(value interface{}) error {
...
func (e *AvencAlac) GetDumpSeparator() (string, error) {
	var value string
	var ok bool
...
func (e *AvencAlac) SetDumpSeparator(value string) error {
...
func (e *AvencAlac) GetErrDetect() (interface{}, error) {
	return e.Element.GetProperty("err-detect")
}

func (e *AvencAlac) SetErrDetect(value interface{}) error {
...
func (e *AvencAlac) GetExportSideData() (interface{}, error) {
	return e.Element.GetProperty("export-side-data")
}

func (e *AvencAlac) SetExportSideData(value interface{}) error {
...
func (e *AvencAlac) GetFlags() (interface{}, error) {
	return e.Element.GetProperty("flags")
}

func (e *AvencAlac) SetFlags(value interface{}) error {
...
func (e *AvencAlac) GetFlags2() (interface{}, error) {
	return e.Element.GetProperty("flags2")
}

func (e *AvencAlac) SetFlags2(value interface{}) error {
...
func (e *AvencAlac) GetFrameSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAlac) SetFrameSize(value int) error {
...
func (e *AvencAlac) GetGlobalQuality() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAlac) SetGlobalQuality(value int) error {
...
func (e *AvencAlac) GetMaxPixels() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAlac) SetMaxPixels(value int64) error {
...
func (e *AvencAlac) GetMaxPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAlac) SetMaxPredictionOrder(value int) error {
...
func (e *AvencAlac) GetMaxSamples() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAlac) SetMaxSamples(value int64) error {
...
func (e *AvencAlac) GetMaxrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAlac) SetMaxrate(value int64) error {
...
func (e *AvencAlac) GetMinPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAlac) SetMinPredictionOrder(value int) error {
...
func (e *AvencAlac) GetMinrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAlac) SetMinrate(value int64) error {
...
func (e *AvencAlac) GetSideDataOnlyPackets() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencAlac) SetSideDataOnlyPackets(value bool) error {
...
func (e *AvencAlac) GetStrict() (interface{}, error) {
	return e.Element.GetProperty("strict")
}

func (e *AvencAlac) SetStrict(value interface{}) error {
...
func (e *AvencAlac) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvencAlac) SetThreadType(value interface{}) error {
...
func (e *AvencAlac) GetThreads() (interface{}, error) {
	return e.Element.GetProperty("threads")
}

func (e *AvencAlac) SetThreads(value interface{}) error {
...
func (e *AvencAlac) GetTicksPerFrame() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAlac) SetTicksPerFrame(value int) error {
...
func (e *AvencAlac) GetTrellis() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAlac) SetTrellis(value int) error {
