...
type AvencAdpcmImaApm struct {
	Element *gst.Element
}

func NewAvencAdpcmImaApm() (*AvencAdpcmImaApm, error) {
	e, err := gst.NewElement("avenc_adpcm_ima_apm")
	if err != nil {
		return nil, err
	}
	return &AvencAdpcmImaApm{Element: e}, nil
}

func NewAvencAdpcmImaApmWithName(name string) (*AvencAdpcmImaApm, error) {
	e, err := gst.NewElementWithName("avenc_adpcm_ima_apm", name)
	if err != nil {
		return nil, err
	}
	return &AvencAdpcmImaApm{Element: e}, nil
...
func (e *AvencAdpcmImaApm) GetAc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaApm) SetAc(value int) error {
...
func (e *AvencAdpcmImaApm) GetAr() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaApm) SetAr(value int) error {
...
func (e *AvencAdpcmImaApm) GetAudioServiceType() (interface{}, error) {
	return e.Element.GetProperty("audio-service-type")
}

func (e *AvencAdpcmImaApm) SetAudioServiceType(value interface{}) error {
...
func (e *AvencAdpcmImaApm) GetBitrate() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaApm) SetBitrate(value int) error {
...
func (e *AvencAdpcmImaApm) GetBlockSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaApm) SetBlockSize(value int) error {
...
func (e *AvencAdpcmImaApm) GetBufsize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaApm) SetBufsize(value int) error {
...
func (e *AvencAdpcmImaApm) GetChannelLayout() (uint64, error) {
	var value uint64
	var ok bool
...
func (e *AvencAdpcmImaApm) SetChannelLayout(value uint64) error {
...
func (e *AvencAdpcmImaApm) GetCompressionLevel() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaApm) SetCompressionLevel(value int) error {
...
func (e *AvencAdpcmImaApm) GetCutoff() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaApm) SetCutoff(value int) error {
...
func (e *AvencAdpcmImaApm) GetDebug() (interface{}, error) {
	return e.Element.GetProperty("debug")
}

func (e *AvencAdpcmImaApm) SetDebug(value interface{}) error {
...
func (e *AvencAdpcmImaApm) GetDumpSeparator() (string, error) {
	var value string
	var ok bool
...
func (e *AvencAdpcmImaApm) SetDumpSeparator(value string) error {
...
func (e *AvencAdpcmImaApm) GetErrDetect() (interface{}, error) {
	return e.Element.GetProperty("err-detect")
}

func (e *AvencAdpcmImaApm) SetErrDetect(value interface{}) error {
...
func (e *AvencAdpcmImaApm) GetExportSideData() (interface{}, error) {
	return e.Element.GetProperty("export-side-data")
}

func (e *AvencAdpcmImaApm) SetExportSideData(value interface{}) error {
...
func (e *AvencAdpcmImaApm) GetFlags() (interface{}, error) {
	return e.Element.GetProperty("flags")
}

func (e *AvencAdpcmImaApm) SetFlags(value interface{}) error {
...
func (e *AvencAdpcmImaApm) GetFlags2() (interface{}, error) {
	return e.Element.GetProperty("flags2")
}

func (e *AvencAdpcmImaApm) SetFlags2(value interface{}) error {
...
func (e *AvencAdpcmImaApm) GetFrameSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaApm) SetFrameSize(value int) error {
...
func (e *AvencAdpcmImaApm) GetGlobalQuality() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaApm) SetGlobalQuality(value int) error {
...
func (e *AvencAdpcmImaApm) GetMaxPixels() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAdpcmImaApm) SetMaxPixels(value int64) error {
...
func (e *AvencAdpcmImaApm) GetMaxPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaApm) SetMaxPredictionOrder(value int) error {
...
func (e *AvencAdpcmImaApm) GetMaxSamples() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAdpcmImaApm) SetMaxSamples(value int64) error {
...
func (e *AvencAdpcmImaApm) GetMaxrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAdpcmImaApm) SetMaxrate(value int64) error {
...
func (e *AvencAdpcmImaApm) GetMinPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaApm) SetMinPredictionOrder(value int) error {
...
func (e *AvencAdpcmImaApm) GetMinrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAdpcmImaApm) SetMinrate(value int64) error {
...
func (e *AvencAdpcmImaApm) GetSideDataOnlyPackets() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencAdpcmImaApm) SetSideDataOnlyPackets(value bool) error {
...
func (e *AvencAdpcmImaApm) GetStrict() (interface{}, error) {
	return e.Element.GetProperty("strict")
}

func (e *AvencAdpcmImaApm) SetStrict(value interface{}) error {
...
func (e *AvencAdpcmImaApm) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvencAdpcmImaApm) SetThreadType(value interface{}) error {
...
func (e *AvencAdpcmImaApm) GetThreads() (interface{}, error) {
	return e.Element.GetProperty("threads")
}

func (e *AvencAdpcmImaApm) SetThreads(value interface{}) error {
...
func (e *AvencAdpcmImaApm) GetTicksPerFrame() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaApm) SetTicksPerFrame(value int) error {
...
func (e *AvencAdpcmImaApm) GetTrellis() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaApm) SetTrellis(value int) error {
