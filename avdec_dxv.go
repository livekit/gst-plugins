...
type AvdecDxv struct {
	Element *gst.Element
}

func NewAvdecDxv() (*AvdecDxv, error) {
	e, err := gst.NewElement("avdec_dxv")
	if err != nil {
		return nil, err
	}
	return &AvdecDxv{Element: e}, nil
}

func NewAvdecDxvWithName(name string) (*AvdecDxv, error) {
	e, err := gst.NewElementWithName("avdec_dxv", name)
	if err != nil {
		return nil, err
	}
	return &AvdecDxv{Element: e}, nil
...
func (e *AvdecDxv) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecDxv) SetDebugMv(value bool) error {
...
func (e *AvdecDxv) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecDxv) SetDirectRendering(value bool) error {
...
func (e *AvdecDxv) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecDxv) SetLowres(value interface{}) error {
...
func (e *AvdecDxv) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecDxv) SetMaxThreads(value int) error {
...
func (e *AvdecDxv) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecDxv) SetOutputCorrupt(value bool) error {
...
func (e *AvdecDxv) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecDxv) SetSkipFrame(value interface{}) error {
...
func (e *AvdecDxv) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecDxv) SetThreadType(value interface{}) error {
