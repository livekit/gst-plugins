...
type AvdecHap struct {
	Element *gst.Element
}

func NewAvdecHap() (*AvdecHap, error) {
	e, err := gst.NewElement("avdec_hap")
	if err != nil {
		return nil, err
	}
	return &AvdecHap{Element: e}, nil
}

func NewAvdecHapWithName(name string) (*AvdecHap, error) {
	e, err := gst.NewElementWithName("avdec_hap", name)
	if err != nil {
		return nil, err
	}
	return &AvdecHap{Element: e}, nil
...
func (e *AvdecHap) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecHap) SetDebugMv(value bool) error {
...
func (e *AvdecHap) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecHap) SetDirectRendering(value bool) error {
...
func (e *AvdecHap) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecHap) SetLowres(value interface{}) error {
...
func (e *AvdecHap) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecHap) SetMaxThreads(value int) error {
...
func (e *AvdecHap) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecHap) SetOutputCorrupt(value bool) error {
...
func (e *AvdecHap) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecHap) SetSkipFrame(value interface{}) error {
...
func (e *AvdecHap) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecHap) SetThreadType(value interface{}) error {
