...
type AvdecApng struct {
	Element *gst.Element
}

func NewAvdecApng() (*AvdecApng, error) {
	e, err := gst.NewElement("avdec_apng")
	if err != nil {
		return nil, err
	}
	return &AvdecApng{Element: e}, nil
}

func NewAvdecApngWithName(name string) (*AvdecApng, error) {
	e, err := gst.NewElementWithName("avdec_apng", name)
	if err != nil {
		return nil, err
	}
	return &AvdecApng{Element: e}, nil
...
func (e *AvdecApng) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecApng) SetDebugMv(value bool) error {
...
func (e *AvdecApng) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecApng) SetDirectRendering(value bool) error {
...
func (e *AvdecApng) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecApng) SetLowres(value interface{}) error {
...
func (e *AvdecApng) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecApng) SetMaxThreads(value int) error {
...
func (e *AvdecApng) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecApng) SetOutputCorrupt(value bool) error {
...
func (e *AvdecApng) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecApng) SetSkipFrame(value interface{}) error {
...
func (e *AvdecApng) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecApng) SetThreadType(value interface{}) error {
