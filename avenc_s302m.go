...
type AvencS302M struct {
	Element *gst.Element
}

func NewAvencS302M() (*AvencS302M, error) {
	e, err := gst.NewElement("avenc_s302m")
	if err != nil {
		return nil, err
	}
	return &AvencS302M{Element: e}, nil
}

func NewAvencS302MWithName(name string) (*AvencS302M, error) {
	e, err := gst.NewElementWithName("avenc_s302m", name)
	if err != nil {
		return nil, err
	}
	return &AvencS302M{Element: e}, nil
...
func (e *AvencS302M) GetAc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencS302M) SetAc(value int) error {
...
func (e *AvencS302M) GetAr() (int, error) {
	var value int
	var ok bool
...
func (e *AvencS302M) SetAr(value int) error {
...
func (e *AvencS302M) GetAudioServiceType() (interface{}, error) {
	return e.Element.GetProperty("audio-service-type")
}

func (e *AvencS302M) SetAudioServiceType(value interface{}) error {
...
func (e *AvencS302M) GetBitrate() (int, error) {
	var value int
	var ok bool
...
func (e *AvencS302M) SetBitrate(value int) error {
...
func (e *AvencS302M) GetBufsize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencS302M) SetBufsize(value int) error {
...
func (e *AvencS302M) GetChannelLayout() (uint64, error) {
	var value uint64
	var ok bool
...
func (e *AvencS302M) SetChannelLayout(value uint64) error {
...
func (e *AvencS302M) GetCompressionLevel() (int, error) {
	var value int
	var ok bool
...
func (e *AvencS302M) SetCompressionLevel(value int) error {
...
func (e *AvencS302M) GetCutoff() (int, error) {
	var value int
	var ok bool
...
func (e *AvencS302M) SetCutoff(value int) error {
...
func (e *AvencS302M) GetDebug() (interface{}, error) {
	return e.Element.GetProperty("debug")
}

func (e *AvencS302M) SetDebug(value interface{}) error {
...
func (e *AvencS302M) GetDumpSeparator() (string, error) {
	var value string
	var ok bool
...
func (e *AvencS302M) SetDumpSeparator(value string) error {
...
func (e *AvencS302M) GetErrDetect() (interface{}, error) {
	return e.Element.GetProperty("err-detect")
}

func (e *AvencS302M) SetErrDetect(value interface{}) error {
...
func (e *AvencS302M) GetExportSideData() (interface{}, error) {
	return e.Element.GetProperty("export-side-data")
}

func (e *AvencS302M) SetExportSideData(value interface{}) error {
...
func (e *AvencS302M) GetFlags() (interface{}, error) {
	return e.Element.GetProperty("flags")
}

func (e *AvencS302M) SetFlags(value interface{}) error {
...
func (e *AvencS302M) GetFlags2() (interface{}, error) {
	return e.Element.GetProperty("flags2")
}

func (e *AvencS302M) SetFlags2(value interface{}) error {
...
func (e *AvencS302M) GetFrameSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencS302M) SetFrameSize(value int) error {
...
func (e *AvencS302M) GetGlobalQuality() (int, error) {
	var value int
	var ok bool
...
func (e *AvencS302M) SetGlobalQuality(value int) error {
...
func (e *AvencS302M) GetMaxPixels() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencS302M) SetMaxPixels(value int64) error {
...
func (e *AvencS302M) GetMaxPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencS302M) SetMaxPredictionOrder(value int) error {
...
func (e *AvencS302M) GetMaxSamples() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencS302M) SetMaxSamples(value int64) error {
...
func (e *AvencS302M) GetMaxrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencS302M) SetMaxrate(value int64) error {
...
func (e *AvencS302M) GetMinPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencS302M) SetMinPredictionOrder(value int) error {
...
func (e *AvencS302M) GetMinrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencS302M) SetMinrate(value int64) error {
...
func (e *AvencS302M) GetSideDataOnlyPackets() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencS302M) SetSideDataOnlyPackets(value bool) error {
...
func (e *AvencS302M) GetStrict() (interface{}, error) {
	return e.Element.GetProperty("strict")
}

func (e *AvencS302M) SetStrict(value interface{}) error {
...
func (e *AvencS302M) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvencS302M) SetThreadType(value interface{}) error {
...
func (e *AvencS302M) GetThreads() (interface{}, error) {
	return e.Element.GetProperty("threads")
}

func (e *AvencS302M) SetThreads(value interface{}) error {
...
func (e *AvencS302M) GetTicksPerFrame() (int, error) {
	var value int
	var ok bool
...
func (e *AvencS302M) SetTicksPerFrame(value int) error {
...
func (e *AvencS302M) GetTrellis() (int, error) {
	var value int
	var ok bool
...
func (e *AvencS302M) SetTrellis(value int) error {
