...
type AvdecVp9 struct {
	Element *gst.Element
}

func NewAvdecVp9() (*AvdecVp9, error) {
	e, err := gst.NewElement("avdec_vp9")
	if err != nil {
		return nil, err
	}
	return &AvdecVp9{Element: e}, nil
}

func NewAvdecVp9WithName(name string) (*AvdecVp9, error) {
	e, err := gst.NewElementWithName("avdec_vp9", name)
	if err != nil {
		return nil, err
	}
	return &AvdecVp9{Element: e}, nil
...
func (e *AvdecVp9) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecVp9) SetDebugMv(value bool) error {
...
func (e *AvdecVp9) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecVp9) SetDirectRendering(value bool) error {
...
func (e *AvdecVp9) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecVp9) SetLowres(value interface{}) error {
...
func (e *AvdecVp9) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecVp9) SetMaxThreads(value int) error {
...
func (e *AvdecVp9) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecVp9) SetOutputCorrupt(value bool) error {
...
func (e *AvdecVp9) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecVp9) SetSkipFrame(value interface{}) error {
...
func (e *AvdecVp9) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecVp9) SetThreadType(value interface{}) error {
