...
type AvencAmv struct {
	Element *gst.Element
}

func NewAvencAmv() (*AvencAmv, error) {
	e, err := gst.NewElement("avenc_amv")
	if err != nil {
		return nil, err
	}
	return &AvencAmv{Element: e}, nil
}

func NewAvencAmvWithName(name string) (*AvencAmv, error) {
	e, err := gst.NewElementWithName("avenc_amv", name)
	if err != nil {
		return nil, err
	}
	return &AvencAmv{Element: e}, nil
...
func (e *AvencAmv) GetA53Cc() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencAmv) SetA53Cc(value bool) error {
...
func (e *AvencAmv) GetBQfactor() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencAmv) SetBQfactor(value float32) error {
...
func (e *AvencAmv) GetBQoffset() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencAmv) SetBQoffset(value float32) error {
...
func (e *AvencAmv) GetBSensitivity() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetBSensitivity(value int) error {
...
func (e *AvencAmv) GetBStrategy() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetBStrategy(value int) error {
...
func (e *AvencAmv) GetBidirRefine() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetBidirRefine(value int) error {
...
func (e *AvencAmv) GetBitrate() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetBitrate(value int) error {
...
func (e *AvencAmv) GetBitrateTolerance() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetBitrateTolerance(value int) error {
...
func (e *AvencAmv) GetBorderMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencAmv) SetBorderMask(value float32) error {
...
func (e *AvencAmv) GetBrdScale() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetBrdScale(value int) error {
...
func (e *AvencAmv) GetBufsize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetBufsize(value int) error {
...
func (e *AvencAmv) GetChromaElimThreshold() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetChromaElimThreshold(value int) error {
...
func (e *AvencAmv) GetChromaSampleLocation() (interface{}, error) {
	return e.Element.GetProperty("chroma-sample-location")
}

func (e *AvencAmv) SetChromaSampleLocation(value interface{}) error {
...
func (e *AvencAmv) GetChromaoffset() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetChromaoffset(value int) error {
...
func (e *AvencAmv) GetCmp() (interface{}, error) {
	return e.Element.GetProperty("cmp")
}

func (e *AvencAmv) SetCmp(value interface{}) error {
...
func (e *AvencAmv) GetCoder() (interface{}, error) {
	return e.Element.GetProperty("coder")
}

func (e *AvencAmv) SetCoder(value interface{}) error {
...
func (e *AvencAmv) GetCompressionLevel() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetCompressionLevel(value int) error {
...
func (e *AvencAmv) GetContext() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetContext(value int) error {
...
func (e *AvencAmv) GetDarkMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencAmv) SetDarkMask(value float32) error {
...
func (e *AvencAmv) GetDc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetDc(value int) error {
...
func (e *AvencAmv) GetDct() (interface{}, error) {
	return e.Element.GetProperty("dct")
}

func (e *AvencAmv) SetDct(value interface{}) error {
...
func (e *AvencAmv) GetDebug() (interface{}, error) {
	return e.Element.GetProperty("debug")
}

func (e *AvencAmv) SetDebug(value interface{}) error {
...
func (e *AvencAmv) GetDiaSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetDiaSize(value int) error {
...
func (e *AvencAmv) GetDumpSeparator() (string, error) {
	var value string
	var ok bool
...
func (e *AvencAmv) SetDumpSeparator(value string) error {
...
func (e *AvencAmv) GetErrDetect() (interface{}, error) {
	return e.Element.GetProperty("err-detect")
}

func (e *AvencAmv) SetErrDetect(value interface{}) error {
...
func (e *AvencAmv) GetErrorRate() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetErrorRate(value int) error {
...
func (e *AvencAmv) GetExportSideData() (interface{}, error) {
	return e.Element.GetProperty("export-side-data")
}

func (e *AvencAmv) SetExportSideData(value interface{}) error {
...
func (e *AvencAmv) GetFieldOrder() (interface{}, error) {
	return e.Element.GetProperty("field-order")
}

func (e *AvencAmv) SetFieldOrder(value interface{}) error {
...
func (e *AvencAmv) GetFlags() (interface{}, error) {
	return e.Element.GetProperty("flags")
}

func (e *AvencAmv) SetFlags(value interface{}) error {
...
func (e *AvencAmv) GetFlags2() (interface{}, error) {
	return e.Element.GetProperty("flags2")
}

func (e *AvencAmv) SetFlags2(value interface{}) error {
...
func (e *AvencAmv) GetForceDuplicatedMatrix() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencAmv) SetForceDuplicatedMatrix(value bool) error {
...
func (e *AvencAmv) GetGlobalQuality() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetGlobalQuality(value int) error {
...
func (e *AvencAmv) GetGopSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetGopSize(value int) error {
	return e.Element.SetProperty("gop-size", value)
}

// huffman (GstAmvEncoderHuffman)
//
// Huffman table strategy (Private codec option)

func (e *AvencAmv) GetHuffman() (interface{}, error) {
	return e.Element.GetProperty("huffman")
}

func (e *AvencAmv) SetHuffman(value interface{}) error {
	return e.Element.SetProperty("huffman", value)
}
...
func (e *AvencAmv) GetIQfactor() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencAmv) SetIQfactor(value float32) error {
...
func (e *AvencAmv) GetIQoffset() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencAmv) SetIQoffset(value float32) error {
...
func (e *AvencAmv) GetIbias() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetIbias(value int) error {
...
func (e *AvencAmv) GetIdct() (interface{}, error) {
	return e.Element.GetProperty("idct")
}

func (e *AvencAmv) SetIdct(value interface{}) error {
...
func (e *AvencAmv) GetIldctcmp() (interface{}, error) {
	return e.Element.GetProperty("ildctcmp")
}

func (e *AvencAmv) SetIldctcmp(value interface{}) error {
...
func (e *AvencAmv) GetIntraPenalty() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetIntraPenalty(value int) error {
...
func (e *AvencAmv) GetKeyintMin() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetKeyintMin(value int) error {
...
func (e *AvencAmv) GetLastPred() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetLastPred(value int) error {
...
func (e *AvencAmv) GetLmax() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetLmax(value int) error {
...
func (e *AvencAmv) GetLmin() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetLmin(value int) error {
...
func (e *AvencAmv) GetLumaElimThreshold() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetLumaElimThreshold(value int) error {
...
func (e *AvencAmv) GetLumiMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencAmv) SetLumiMask(value float32) error {
...
func (e *AvencAmv) GetMaxBframes() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetMaxBframes(value int) error {
...
func (e *AvencAmv) GetMaxPixels() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAmv) SetMaxPixels(value int64) error {
...
func (e *AvencAmv) GetMaxrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAmv) SetMaxrate(value int64) error {
...
func (e *AvencAmv) GetMbcmp() (interface{}, error) {
	return e.Element.GetProperty("mbcmp")
}

func (e *AvencAmv) SetMbcmp(value interface{}) error {
...
func (e *AvencAmv) GetMbd() (interface{}, error) {
	return e.Element.GetProperty("mbd")
}

func (e *AvencAmv) SetMbd(value interface{}) error {
...
func (e *AvencAmv) GetMblmax() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetMblmax(value int) error {
...
func (e *AvencAmv) GetMblmin() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetMblmin(value int) error {
...
func (e *AvencAmv) GetMeRange() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetMeRange(value int) error {
...
func (e *AvencAmv) GetMepc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetMepc(value int) error {
...
func (e *AvencAmv) GetMepre() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetMepre(value int) error {
...
func (e *AvencAmv) GetMinrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAmv) SetMinrate(value int64) error {
	return e.Element.SetProperty("minrate", value)
}

// motion-est (GstAmvEncoderMotionEst)
//
// motion estimation algorithm (Private codec option)

func (e *AvencAmv) GetMotionEst() (interface{}, error) {
	return e.Element.GetProperty("motion-est")
}

func (e *AvencAmv) SetMotionEst(value interface{}) error {
...
func (e *AvencAmv) GetMpegQuant() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetMpegQuant(value int) error {
	return e.Element.SetProperty("mpeg-quant", value)
}

// mpv-flags (GstAmvEncoderMpvFlags)
//
// Flags common for all mpegvideo-based encoders. (Private codec option)

func (e *AvencAmv) GetMpvFlags() (interface{}, error) {
	return e.Element.GetProperty("mpv-flags")
}

func (e *AvencAmv) SetMpvFlags(value interface{}) error {
...
func (e *AvencAmv) GetMultipassCacheFile() (string, error) {
	var value string
	var ok bool
...
func (e *AvencAmv) SetMultipassCacheFile(value string) error {
...
func (e *AvencAmv) GetMv0Threshold() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetMv0Threshold(value int) error {
...
func (e *AvencAmv) GetNoiseReduction() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetNoiseReduction(value int) error {
...
func (e *AvencAmv) GetNr() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetNr(value int) error {
...
func (e *AvencAmv) GetNssew() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetNssew(value int) error {
...
func (e *AvencAmv) GetPMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencAmv) SetPMask(value float32) error {
...
func (e *AvencAmv) GetPass() (interface{}, error) {
	return e.Element.GetProperty("pass")
}

func (e *AvencAmv) SetPass(value interface{}) error {
...
func (e *AvencAmv) GetPbias() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetPbias(value int) error {
...
func (e *AvencAmv) GetPreDiaSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetPreDiaSize(value int) error {
...
func (e *AvencAmv) GetPrecmp() (interface{}, error) {
	return e.Element.GetProperty("precmp")
}

func (e *AvencAmv) SetPrecmp(value interface{}) error {
	return e.Element.SetProperty("precmp", value)
}

// pred (GstAmvEncoderPred)
//
// Prediction method (Private codec option)

func (e *AvencAmv) GetPred() (interface{}, error) {
	return e.Element.GetProperty("pred")
}

func (e *AvencAmv) SetPred(value interface{}) error {
...
func (e *AvencAmv) GetPreme() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetPreme(value int) error {
...
func (e *AvencAmv) GetPs() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetPs(value int) error {
...
func (e *AvencAmv) GetQblur() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencAmv) SetQblur(value float32) error {
...
func (e *AvencAmv) GetQcomp() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencAmv) SetQcomp(value float32) error {
...
func (e *AvencAmv) GetQdiff() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetQdiff(value int) error {
...
func (e *AvencAmv) GetQmax() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetQmax(value int) error {
...
func (e *AvencAmv) GetQmin() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetQmin(value int) error {
...
func (e *AvencAmv) GetQsquish() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencAmv) SetQsquish(value float32) error {
...
func (e *AvencAmv) GetQuantizer() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencAmv) SetQuantizer(value float32) error {
...
func (e *AvencAmv) GetQuantizerNoiseShaping() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetQuantizerNoiseShaping(value int) error {
...
func (e *AvencAmv) GetRcBufAggressivity() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencAmv) SetRcBufAggressivity(value float32) error {
...
func (e *AvencAmv) GetRcEq() (string, error) {
	var value string
	var ok bool
...
func (e *AvencAmv) SetRcEq(value string) error {
...
func (e *AvencAmv) GetRcInitCplx() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencAmv) SetRcInitCplx(value float32) error {
...
func (e *AvencAmv) GetRcInitOccupancy() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetRcInitOccupancy(value int) error {
...
func (e *AvencAmv) GetRcMaxVbvUse() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencAmv) SetRcMaxVbvUse(value float32) error {
...
func (e *AvencAmv) GetRcMinVbvUse() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencAmv) SetRcMinVbvUse(value float32) error {
...
func (e *AvencAmv) GetRcQmodAmp() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencAmv) SetRcQmodAmp(value float32) error {
...
func (e *AvencAmv) GetRcQmodFreq() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetRcQmodFreq(value int) error {
	return e.Element.SetProperty("rc-qmod-freq", value)
}

// rc-strategy (GstAmvEncoderRcStrategy)
//
// ratecontrol method (Private codec option)

func (e *AvencAmv) GetRcStrategy() (interface{}, error) {
	return e.Element.GetProperty("rc-strategy")
}

func (e *AvencAmv) SetRcStrategy(value interface{}) error {
...
func (e *AvencAmv) GetRefs() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetRefs(value int) error {
...
func (e *AvencAmv) GetScThreshold() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetScThreshold(value int) error {
...
func (e *AvencAmv) GetScplxMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencAmv) SetScplxMask(value float32) error {
...
func (e *AvencAmv) GetSideDataOnlyPackets() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencAmv) SetSideDataOnlyPackets(value bool) error {
	return e.Element.SetProperty("side-data-only-packets", value)
}

// skip-cmp (GstAmvEncoderCmpFunc)
//
// Frame skip compare function (Private codec option)

func (e *AvencAmv) GetSkipCmp() (interface{}, error) {
	return e.Element.GetProperty("skip-cmp")
}

func (e *AvencAmv) SetSkipCmp(value interface{}) error {
...
func (e *AvencAmv) GetSkipExp() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetSkipExp(value int) error {
...
func (e *AvencAmv) GetSkipFactor() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetSkipFactor(value int) error {
...
func (e *AvencAmv) GetSkipThreshold() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetSkipThreshold(value int) error {
...
func (e *AvencAmv) GetSlices() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetSlices(value int) error {
...
func (e *AvencAmv) GetStrict() (interface{}, error) {
	return e.Element.GetProperty("strict")
}

func (e *AvencAmv) SetStrict(value interface{}) error {
...
func (e *AvencAmv) GetSubcmp() (interface{}, error) {
	return e.Element.GetProperty("subcmp")
}

func (e *AvencAmv) SetSubcmp(value interface{}) error {
...
func (e *AvencAmv) GetSubq() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetSubq(value int) error {
...
func (e *AvencAmv) GetTcplxMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencAmv) SetTcplxMask(value float32) error {
...
func (e *AvencAmv) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvencAmv) SetThreadType(value interface{}) error {
...
func (e *AvencAmv) GetThreads() (interface{}, error) {
	return e.Element.GetProperty("threads")
}

func (e *AvencAmv) SetThreads(value interface{}) error {
...
func (e *AvencAmv) GetTicksPerFrame() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetTicksPerFrame(value int) error {
...
func (e *AvencAmv) GetTimecodeFrameStart() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAmv) SetTimecodeFrameStart(value int64) error {
...
func (e *AvencAmv) GetTrellis() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAmv) SetTrellis(value int) error {
	return e.Element.SetProperty("trellis", value)
}

// ----- Constants -----

type AmvEncoderCmpFunc string

const (
	AmvEncoderCmpFuncSad AmvEncoderCmpFunc = "sad" // sad (0) – Sum of absolute differences, fast
	AmvEncoderCmpFuncSse AmvEncoderCmpFunc = "sse" // sse (1) – Sum of squared errors
	AmvEncoderCmpFuncSatd AmvEncoderCmpFunc = "satd" // satd (2) – Sum of absolute Hadamard transformed differences
	AmvEncoderCmpFuncDct AmvEncoderCmpFunc = "dct" // dct (3) – Sum of absolute DCT transformed differences
	AmvEncoderCmpFuncPsnr AmvEncoderCmpFunc = "psnr" // psnr (4) – Sum of squared quantization errors, low quality
	AmvEncoderCmpFuncBit AmvEncoderCmpFunc = "bit" // bit (5) – Number of bits needed for the block
	AmvEncoderCmpFuncRd AmvEncoderCmpFunc = "rd" // rd (6) – Rate distortion optimal, slow
	AmvEncoderCmpFuncZero AmvEncoderCmpFunc = "zero" // zero (7) – Zero
	AmvEncoderCmpFuncVsad AmvEncoderCmpFunc = "vsad" // vsad (8) – Sum of absolute vertical differences
	AmvEncoderCmpFuncVsse AmvEncoderCmpFunc = "vsse" // vsse (9) – Sum of squared vertical differences
	AmvEncoderCmpFuncNsse AmvEncoderCmpFunc = "nsse" // nsse (10) – Noise preserving sum of squared differences
	AmvEncoderCmpFuncDctmax AmvEncoderCmpFunc = "dctmax" // dctmax (13) – dctmax
	AmvEncoderCmpFuncDct264 AmvEncoderCmpFunc = "dct264" // dct264 (14) – dct264
	AmvEncoderCmpFuncMsad AmvEncoderCmpFunc = "msad" // msad (15) – Sum of absolute differences, median predicted
	AmvEncoderCmpFuncChroma AmvEncoderCmpFunc = "chroma" // chroma (256) – chroma
)

type AmvEncoderHuffman string

const (
	AmvEncoderHuffmanDefault AmvEncoderHuffman = "default" // default (0) – default
	AmvEncoderHuffmanOptimal AmvEncoderHuffman = "optimal" // optimal (1) – optimal
)

type AmvEncoderMotionEst string

const (
	AmvEncoderMotionEstZero AmvEncoderMotionEst = "zero" // zero (0) – zero
	AmvEncoderMotionEstEpzs AmvEncoderMotionEst = "epzs" // epzs (1) – epzs
	AmvEncoderMotionEstXone AmvEncoderMotionEst = "xone" // xone (2) – xone
)

type AmvEncoderMpvFlags string

const (
	AmvEncoderMpvFlagsSkipRd AmvEncoderMpvFlags = "skip_rd" // skip_rd (0x00000001) – RD optimal MB level residual skipping
	AmvEncoderMpvFlagsStrictGop AmvEncoderMpvFlags = "strict_gop" // strict_gop (0x00000002) – Strictly enforce gop size
	AmvEncoderMpvFlagsQpRd AmvEncoderMpvFlags = "qp_rd" // qp_rd (0x00000004) – Use rate distortion optimization for qp selection
	AmvEncoderMpvFlagsCbpRd AmvEncoderMpvFlags = "cbp_rd" // cbp_rd (0x00000008) – use rate distortion optimization for CBP
	AmvEncoderMpvFlagsNaq AmvEncoderMpvFlags = "naq" // naq (0x00000010) – normalize adaptive quantization
	AmvEncoderMpvFlagsMv0 AmvEncoderMpvFlags = "mv0" // mv0 (0x00000020) – always try a mb with mv=<0,0>
)

type AmvEncoderPred string

const (
	AmvEncoderPredLeft AmvEncoderPred = "left" // left (1) – left
	AmvEncoderPredPlane AmvEncoderPred = "plane" // plane (2) – plane
	AmvEncoderPredMedian AmvEncoderPred = "median" // median (3) – median
)

type AmvEncoderRcStrategy string

const (
	AmvEncoderRcStrategyFfmpeg AmvEncoderRcStrategy = "ffmpeg" // ffmpeg (0) – deprecated, does nothing
)
