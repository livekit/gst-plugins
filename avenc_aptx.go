...
type AvencAptx struct {
	Element *gst.Element
}

func NewAvencAptx() (*AvencAptx, error) {
	e, err := gst.NewElement("avenc_aptx")
	if err != nil {
		return nil, err
	}
	return &AvencAptx{Element: e}, nil
}

func NewAvencAptxWithName(name string) (*AvencAptx, error) {
	e, err := gst.NewElementWithName("avenc_aptx", name)
	if err != nil {
		return nil, err
	}
	return &AvencAptx{Element: e}, nil
...
func (e *AvencAptx) GetAc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptx) SetAc(value int) error {
...
func (e *AvencAptx) GetAr() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptx) SetAr(value int) error {
...
func (e *AvencAptx) GetAudioServiceType() (interface{}, error) {
	return e.Element.GetProperty("audio-service-type")
}

func (e *AvencAptx) SetAudioServiceType(value interface{}) error {
...
func (e *AvencAptx) GetBitrate() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptx) SetBitrate(value int) error {
...
func (e *AvencAptx) GetBufsize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptx) SetBufsize(value int) error {
...
func (e *AvencAptx) GetChannelLayout() (uint64, error) {
	var value uint64
	var ok bool
...
func (e *AvencAptx) SetChannelLayout(value uint64) error {
...
func (e *AvencAptx) GetCompressionLevel() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptx) SetCompressionLevel(value int) error {
...
func (e *AvencAptx) GetCutoff() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptx) SetCutoff(value int) error {
...
func (e *AvencAptx) GetDebug() (interface{}, error) {
	return e.Element.GetProperty("debug")
}

func (e *AvencAptx) SetDebug(value interface{}) error {
...
func (e *AvencAptx) GetDumpSeparator() (string, error) {
	var value string
	var ok bool
...
func (e *AvencAptx) SetDumpSeparator(value string) error {
...
func (e *AvencAptx) GetErrDetect() (interface{}, error) {
	return e.Element.GetProperty("err-detect")
}

func (e *AvencAptx) SetErrDetect(value interface{}) error {
...
func (e *AvencAptx) GetExportSideData() (interface{}, error) {
	return e.Element.GetProperty("export-side-data")
}

func (e *AvencAptx) SetExportSideData(value interface{}) error {
...
func (e *AvencAptx) GetFlags() (interface{}, error) {
	return e.Element.GetProperty("flags")
}

func (e *AvencAptx) SetFlags(value interface{}) error {
...
func (e *AvencAptx) GetFlags2() (interface{}, error) {
	return e.Element.GetProperty("flags2")
}

func (e *AvencAptx) SetFlags2(value interface{}) error {
...
func (e *AvencAptx) GetFrameSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptx) SetFrameSize(value int) error {
...
func (e *AvencAptx) GetGlobalQuality() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptx) SetGlobalQuality(value int) error {
...
func (e *AvencAptx) GetMaxPixels() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAptx) SetMaxPixels(value int64) error {
...
func (e *AvencAptx) GetMaxPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptx) SetMaxPredictionOrder(value int) error {
...
func (e *AvencAptx) GetMaxSamples() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAptx) SetMaxSamples(value int64) error {
...
func (e *AvencAptx) GetMaxrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAptx) SetMaxrate(value int64) error {
...
func (e *AvencAptx) GetMinPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptx) SetMinPredictionOrder(value int) error {
...
func (e *AvencAptx) GetMinrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAptx) SetMinrate(value int64) error {
...
func (e *AvencAptx) GetSideDataOnlyPackets() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencAptx) SetSideDataOnlyPackets(value bool) error {
...
func (e *AvencAptx) GetStrict() (interface{}, error) {
	return e.Element.GetProperty("strict")
}

func (e *AvencAptx) SetStrict(value interface{}) error {
...
func (e *AvencAptx) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvencAptx) SetThreadType(value interface{}) error {
...
func (e *AvencAptx) GetThreads() (interface{}, error) {
	return e.Element.GetProperty("threads")
}

func (e *AvencAptx) SetThreads(value interface{}) error {
...
func (e *AvencAptx) GetTicksPerFrame() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptx) SetTicksPerFrame(value int) error {
...
func (e *AvencAptx) GetTrellis() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptx) SetTrellis(value int) error {
