...
type AvdecRv30 struct {
	Element *gst.Element
}

func NewAvdecRv30() (*AvdecRv30, error) {
	e, err := gst.NewElement("avdec_rv30")
	if err != nil {
		return nil, err
	}
	return &AvdecRv30{Element: e}, nil
}

func NewAvdecRv30WithName(name string) (*AvdecRv30, error) {
	e, err := gst.NewElementWithName("avdec_rv30", name)
	if err != nil {
		return nil, err
	}
	return &AvdecRv30{Element: e}, nil
...
func (e *AvdecRv30) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecRv30) SetDebugMv(value bool) error {
...
func (e *AvdecRv30) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecRv30) SetDirectRendering(value bool) error {
...
func (e *AvdecRv30) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecRv30) SetLowres(value interface{}) error {
...
func (e *AvdecRv30) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecRv30) SetMaxThreads(value int) error {
...
func (e *AvdecRv30) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecRv30) SetOutputCorrupt(value bool) error {
...
func (e *AvdecRv30) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecRv30) SetSkipFrame(value interface{}) error {
...
func (e *AvdecRv30) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecRv30) SetThreadType(value interface{}) error {
