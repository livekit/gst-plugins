...
func NewInterleave() (*Interleave, error) {
	e, err := gst.NewElement("interleave")
	if err != nil {
		return nil, err
	}
	return &Interleave{Element: e}, nil
}

func NewInterleaveWithName(name string) (*Interleave, error) {
...
func (e *Interleave) GetChannelPositionsFromInput() (bool, error) {
	var value bool
	var ok bool
...
func (e *Interleave) SetChannelPositionsFromInput(value bool) error {
