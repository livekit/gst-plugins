...
type AvdecDds struct {
	Element *gst.Element
}

func NewAvdecDds() (*AvdecDds, error) {
	e, err := gst.NewElement("avdec_dds")
	if err != nil {
		return nil, err
	}
	return &AvdecDds{Element: e}, nil
}

func NewAvdecDdsWithName(name string) (*AvdecDds, error) {
	e, err := gst.NewElementWithName("avdec_dds", name)
	if err != nil {
		return nil, err
	}
	return &AvdecDds{Element: e}, nil
...
func (e *AvdecDds) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecDds) SetDebugMv(value bool) error {
...
func (e *AvdecDds) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecDds) SetDirectRendering(value bool) error {
...
func (e *AvdecDds) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecDds) SetLowres(value interface{}) error {
...
func (e *AvdecDds) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecDds) SetMaxThreads(value int) error {
...
func (e *AvdecDds) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecDds) SetOutputCorrupt(value bool) error {
...
func (e *AvdecDds) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecDds) SetSkipFrame(value interface{}) error {
...
func (e *AvdecDds) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecDds) SetThreadType(value interface{}) error {
