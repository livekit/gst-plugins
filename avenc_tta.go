...
type AvencTta struct {
	Element *gst.Element
}

func NewAvencTta() (*AvencTta, error) {
	e, err := gst.NewElement("avenc_tta")
	if err != nil {
		return nil, err
	}
	return &AvencTta{Element: e}, nil
}

func NewAvencTtaWithName(name string) (*AvencTta, error) {
	e, err := gst.NewElementWithName("avenc_tta", name)
	if err != nil {
		return nil, err
	}
	return &AvencTta{Element: e}, nil
...
func (e *AvencTta) GetAc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTta) SetAc(value int) error {
...
func (e *AvencTta) GetAr() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTta) SetAr(value int) error {
...
func (e *AvencTta) GetAudioServiceType() (interface{}, error) {
	return e.Element.GetProperty("audio-service-type")
}

func (e *AvencTta) SetAudioServiceType(value interface{}) error {
...
func (e *AvencTta) GetBitrate() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTta) SetBitrate(value int) error {
...
func (e *AvencTta) GetBufsize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTta) SetBufsize(value int) error {
...
func (e *AvencTta) GetChannelLayout() (uint64, error) {
	var value uint64
	var ok bool
...
func (e *AvencTta) SetChannelLayout(value uint64) error {
...
func (e *AvencTta) GetCompressionLevel() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTta) SetCompressionLevel(value int) error {
...
func (e *AvencTta) GetCutoff() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTta) SetCutoff(value int) error {
...
func (e *AvencTta) GetDebug() (interface{}, error) {
	return e.Element.GetProperty("debug")
}

func (e *AvencTta) SetDebug(value interface{}) error {
...
func (e *AvencTta) GetDumpSeparator() (string, error) {
	var value string
	var ok bool
...
func (e *AvencTta) SetDumpSeparator(value string) error {
...
func (e *AvencTta) GetErrDetect() (interface{}, error) {
	return e.Element.GetProperty("err-detect")
}

func (e *AvencTta) SetErrDetect(value interface{}) error {
...
func (e *AvencTta) GetExportSideData() (interface{}, error) {
	return e.Element.GetProperty("export-side-data")
}

func (e *AvencTta) SetExportSideData(value interface{}) error {
...
func (e *AvencTta) GetFlags() (interface{}, error) {
	return e.Element.GetProperty("flags")
}

func (e *AvencTta) SetFlags(value interface{}) error {
...
func (e *AvencTta) GetFlags2() (interface{}, error) {
	return e.Element.GetProperty("flags2")
}

func (e *AvencTta) SetFlags2(value interface{}) error {
...
func (e *AvencTta) GetFrameSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTta) SetFrameSize(value int) error {
...
func (e *AvencTta) GetGlobalQuality() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTta) SetGlobalQuality(value int) error {
...
func (e *AvencTta) GetMaxPixels() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencTta) SetMaxPixels(value int64) error {
...
func (e *AvencTta) GetMaxPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTta) SetMaxPredictionOrder(value int) error {
...
func (e *AvencTta) GetMaxSamples() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencTta) SetMaxSamples(value int64) error {
...
func (e *AvencTta) GetMaxrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencTta) SetMaxrate(value int64) error {
...
func (e *AvencTta) GetMinPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTta) SetMinPredictionOrder(value int) error {
...
func (e *AvencTta) GetMinrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencTta) SetMinrate(value int64) error {
...
func (e *AvencTta) GetSideDataOnlyPackets() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencTta) SetSideDataOnlyPackets(value bool) error {
...
func (e *AvencTta) GetStrict() (interface{}, error) {
	return e.Element.GetProperty("strict")
}

func (e *AvencTta) SetStrict(value interface{}) error {
...
func (e *AvencTta) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvencTta) SetThreadType(value interface{}) error {
...
func (e *AvencTta) GetThreads() (interface{}, error) {
	return e.Element.GetProperty("threads")
}

func (e *AvencTta) SetThreads(value interface{}) error {
...
func (e *AvencTta) GetTicksPerFrame() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTta) SetTicksPerFrame(value int) error {
...
func (e *AvencTta) GetTrellis() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTta) SetTrellis(value int) error {
