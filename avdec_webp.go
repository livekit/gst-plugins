...
type AvdecWebp struct {
	Element *gst.Element
}

func NewAvdecWebp() (*AvdecWebp, error) {
	e, err := gst.NewElement("avdec_webp")
	if err != nil {
		return nil, err
	}
	return &AvdecWebp{Element: e}, nil
}

func NewAvdecWebpWithName(name string) (*AvdecWebp, error) {
	e, err := gst.NewElementWithName("avdec_webp", name)
	if err != nil {
		return nil, err
	}
	return &AvdecWebp{Element: e}, nil
...
func (e *AvdecWebp) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecWebp) SetDebugMv(value bool) error {
...
func (e *AvdecWebp) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecWebp) SetDirectRendering(value bool) error {
...
func (e *AvdecWebp) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecWebp) SetLowres(value interface{}) error {
...
func (e *AvdecWebp) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecWebp) SetMaxThreads(value int) error {
...
func (e *AvdecWebp) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecWebp) SetOutputCorrupt(value bool) error {
...
func (e *AvdecWebp) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecWebp) SetSkipFrame(value interface{}) error {
...
func (e *AvdecWebp) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecWebp) SetThreadType(value interface{}) error {
