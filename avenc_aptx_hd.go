...
type AvencAptxHd struct {
	Element *gst.Element
}

func NewAvencAptxHd() (*AvencAptxHd, error) {
	e, err := gst.NewElement("avenc_aptx_hd")
	if err != nil {
		return nil, err
	}
	return &AvencAptxHd{Element: e}, nil
}

func NewAvencAptxHdWithName(name string) (*AvencAptxHd, error) {
	e, err := gst.NewElementWithName("avenc_aptx_hd", name)
	if err != nil {
		return nil, err
	}
	return &AvencAptxHd{Element: e}, nil
...
func (e *AvencAptxHd) GetAc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptxHd) SetAc(value int) error {
...
func (e *AvencAptxHd) GetAr() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptxHd) SetAr(value int) error {
...
func (e *AvencAptxHd) GetAudioServiceType() (interface{}, error) {
	return e.Element.GetProperty("audio-service-type")
}

func (e *AvencAptxHd) SetAudioServiceType(value interface{}) error {
...
func (e *AvencAptxHd) GetBitrate() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptxHd) SetBitrate(value int) error {
...
func (e *AvencAptxHd) GetBufsize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptxHd) SetBufsize(value int) error {
...
func (e *AvencAptxHd) GetChannelLayout() (uint64, error) {
	var value uint64
	var ok bool
...
func (e *AvencAptxHd) SetChannelLayout(value uint64) error {
...
func (e *AvencAptxHd) GetCompressionLevel() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptxHd) SetCompressionLevel(value int) error {
...
func (e *AvencAptxHd) GetCutoff() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptxHd) SetCutoff(value int) error {
...
func (e *AvencAptxHd) GetDebug() (interface{}, error) {
	return e.Element.GetProperty("debug")
}

func (e *AvencAptxHd) SetDebug(value interface{}) error {
...
func (e *AvencAptxHd) GetDumpSeparator() (string, error) {
	var value string
	var ok bool
...
func (e *AvencAptxHd) SetDumpSeparator(value string) error {
...
func (e *AvencAptxHd) GetErrDetect() (interface{}, error) {
	return e.Element.GetProperty("err-detect")
}

func (e *AvencAptxHd) SetErrDetect(value interface{}) error {
...
func (e *AvencAptxHd) GetExportSideData() (interface{}, error) {
	return e.Element.GetProperty("export-side-data")
}

func (e *AvencAptxHd) SetExportSideData(value interface{}) error {
...
func (e *AvencAptxHd) GetFlags() (interface{}, error) {
	return e.Element.GetProperty("flags")
}

func (e *AvencAptxHd) SetFlags(value interface{}) error {
...
func (e *AvencAptxHd) GetFlags2() (interface{}, error) {
	return e.Element.GetProperty("flags2")
}

func (e *AvencAptxHd) SetFlags2(value interface{}) error {
...
func (e *AvencAptxHd) GetFrameSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptxHd) SetFrameSize(value int) error {
...
func (e *AvencAptxHd) GetGlobalQuality() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptxHd) SetGlobalQuality(value int) error {
...
func (e *AvencAptxHd) GetMaxPixels() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAptxHd) SetMaxPixels(value int64) error {
...
func (e *AvencAptxHd) GetMaxPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptxHd) SetMaxPredictionOrder(value int) error {
...
func (e *AvencAptxHd) GetMaxSamples() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAptxHd) SetMaxSamples(value int64) error {
...
func (e *AvencAptxHd) GetMaxrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAptxHd) SetMaxrate(value int64) error {
...
func (e *AvencAptxHd) GetMinPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptxHd) SetMinPredictionOrder(value int) error {
...
func (e *AvencAptxHd) GetMinrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAptxHd) SetMinrate(value int64) error {
...
func (e *AvencAptxHd) GetSideDataOnlyPackets() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencAptxHd) SetSideDataOnlyPackets(value bool) error {
...
func (e *AvencAptxHd) GetStrict() (interface{}, error) {
	return e.Element.GetProperty("strict")
}

func (e *AvencAptxHd) SetStrict(value interface{}) error {
...
func (e *AvencAptxHd) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvencAptxHd) SetThreadType(value interface{}) error {
...
func (e *AvencAptxHd) GetThreads() (interface{}, error) {
	return e.Element.GetProperty("threads")
}

func (e *AvencAptxHd) SetThreads(value interface{}) error {
...
func (e *AvencAptxHd) GetTicksPerFrame() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptxHd) SetTicksPerFrame(value int) error {
...
func (e *AvencAptxHd) GetTrellis() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAptxHd) SetTrellis(value int) error {
