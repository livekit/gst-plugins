...
type AvdecMdec struct {
	Element *gst.Element
}

func NewAvdecMdec() (*AvdecMdec, error) {
	e, err := gst.NewElement("avdec_mdec")
	if err != nil {
		return nil, err
	}
	return &AvdecMdec{Element: e}, nil
}

func NewAvdecMdecWithName(name string) (*AvdecMdec, error) {
	e, err := gst.NewElementWithName("avdec_mdec", name)
	if err != nil {
		return nil, err
	}
	return &AvdecMdec{Element: e}, nil
...
func (e *AvdecMdec) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecMdec) SetDebugMv(value bool) error {
...
func (e *AvdecMdec) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecMdec) SetDirectRendering(value bool) error {
...
func (e *AvdecMdec) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecMdec) SetLowres(value interface{}) error {
...
func (e *AvdecMdec) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecMdec) SetMaxThreads(value int) error {
...
func (e *AvdecMdec) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecMdec) SetOutputCorrupt(value bool) error {
...
func (e *AvdecMdec) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecMdec) SetSkipFrame(value interface{}) error {
...
func (e *AvdecMdec) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecMdec) SetThreadType(value interface{}) error {
