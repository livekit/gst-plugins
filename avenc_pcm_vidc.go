...
type AvencPcmVidc struct {
	Element *gst.Element
}

func NewAvencPcmVidc() (*AvencPcmVidc, error) {
	e, err := gst.NewElement("avenc_pcm_vidc")
	if err != nil {
		return nil, err
	}
	return &AvencPcmVidc{Element: e}, nil
}

func NewAvencPcmVidcWithName(name string) (*AvencPcmVidc, error) {
	e, err := gst.NewElementWithName("avenc_pcm_vidc", name)
	if err != nil {
		return nil, err
	}
	return &AvencPcmVidc{Element: e}, nil
...
func (e *AvencPcmVidc) GetAc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencPcmVidc) SetAc(value int) error {
...
func (e *AvencPcmVidc) GetAr() (int, error) {
	var value int
	var ok bool
...
func (e *AvencPcmVidc) SetAr(value int) error {
...
func (e *AvencPcmVidc) GetAudioServiceType() (interface{}, error) {
	return e.Element.GetProperty("audio-service-type")
}

func (e *AvencPcmVidc) SetAudioServiceType(value interface{}) error {
...
func (e *AvencPcmVidc) GetBitrate() (int, error) {
	var value int
	var ok bool
...
func (e *AvencPcmVidc) SetBitrate(value int) error {
...
func (e *AvencPcmVidc) GetBufsize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencPcmVidc) SetBufsize(value int) error {
...
func (e *AvencPcmVidc) GetChannelLayout() (uint64, error) {
	var value uint64
	var ok bool
...
func (e *AvencPcmVidc) SetChannelLayout(value uint64) error {
...
func (e *AvencPcmVidc) GetCompressionLevel() (int, error) {
	var value int
	var ok bool
...
func (e *AvencPcmVidc) SetCompressionLevel(value int) error {
...
func (e *AvencPcmVidc) GetCutoff() (int, error) {
	var value int
	var ok bool
...
func (e *AvencPcmVidc) SetCutoff(value int) error {
...
func (e *AvencPcmVidc) GetDebug() (interface{}, error) {
	return e.Element.GetProperty("debug")
}

func (e *AvencPcmVidc) SetDebug(value interface{}) error {
...
func (e *AvencPcmVidc) GetDumpSeparator() (string, error) {
	var value string
	var ok bool
...
func (e *AvencPcmVidc) SetDumpSeparator(value string) error {
...
func (e *AvencPcmVidc) GetErrDetect() (interface{}, error) {
	return e.Element.GetProperty("err-detect")
}

func (e *AvencPcmVidc) SetErrDetect(value interface{}) error {
...
func (e *AvencPcmVidc) GetExportSideData() (interface{}, error) {
	return e.Element.GetProperty("export-side-data")
}

func (e *AvencPcmVidc) SetExportSideData(value interface{}) error {
...
func (e *AvencPcmVidc) GetFlags() (interface{}, error) {
	return e.Element.GetProperty("flags")
}

func (e *AvencPcmVidc) SetFlags(value interface{}) error {
...
func (e *AvencPcmVidc) GetFlags2() (interface{}, error) {
	return e.Element.GetProperty("flags2")
}

func (e *AvencPcmVidc) SetFlags2(value interface{}) error {
...
func (e *AvencPcmVidc) GetFrameSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencPcmVidc) SetFrameSize(value int) error {
...
func (e *AvencPcmVidc) GetGlobalQuality() (int, error) {
	var value int
	var ok bool
...
func (e *AvencPcmVidc) SetGlobalQuality(value int) error {
...
func (e *AvencPcmVidc) GetMaxPixels() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencPcmVidc) SetMaxPixels(value int64) error {
...
func (e *AvencPcmVidc) GetMaxPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencPcmVidc) SetMaxPredictionOrder(value int) error {
...
func (e *AvencPcmVidc) GetMaxSamples() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencPcmVidc) SetMaxSamples(value int64) error {
...
func (e *AvencPcmVidc) GetMaxrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencPcmVidc) SetMaxrate(value int64) error {
...
func (e *AvencPcmVidc) GetMinPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencPcmVidc) SetMinPredictionOrder(value int) error {
...
func (e *AvencPcmVidc) GetMinrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencPcmVidc) SetMinrate(value int64) error {
...
func (e *AvencPcmVidc) GetSideDataOnlyPackets() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencPcmVidc) SetSideDataOnlyPackets(value bool) error {
...
func (e *AvencPcmVidc) GetStrict() (interface{}, error) {
	return e.Element.GetProperty("strict")
}

func (e *AvencPcmVidc) SetStrict(value interface{}) error {
...
func (e *AvencPcmVidc) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvencPcmVidc) SetThreadType(value interface{}) error {
...
func (e *AvencPcmVidc) GetThreads() (interface{}, error) {
	return e.Element.GetProperty("threads")
}

func (e *AvencPcmVidc) SetThreads(value interface{}) error {
...
func (e *AvencPcmVidc) GetTicksPerFrame() (int, error) {
	var value int
	var ok bool
...
func (e *AvencPcmVidc) SetTicksPerFrame(value int) error {
...
func (e *AvencPcmVidc) GetTrellis() (int, error) {
	var value int
	var ok bool
...
func (e *AvencPcmVidc) SetTrellis(value int) error {
