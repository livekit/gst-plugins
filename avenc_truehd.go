...
type AvencTruehd struct {
	Element *gst.Element
}

func NewAvencTruehd() (*AvencTruehd, error) {
	e, err := gst.NewElement("avenc_truehd")
	if err != nil {
		return nil, err
	}
	return &AvencTruehd{Element: e}, nil
}

func NewAvencTruehdWithName(name string) (*AvencTruehd, error) {
	e, err := gst.NewElementWithName("avenc_truehd", name)
	if err != nil {
		return nil, err
	}
	return &AvencTruehd{Element: e}, nil
...
func (e *AvencTruehd) GetAc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTruehd) SetAc(value int) error {
...
func (e *AvencTruehd) GetAr() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTruehd) SetAr(value int) error {
...
func (e *AvencTruehd) GetAudioServiceType() (interface{}, error) {
	return e.Element.GetProperty("audio-service-type")
}

func (e *AvencTruehd) SetAudioServiceType(value interface{}) error {
...
func (e *AvencTruehd) GetBitrate() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTruehd) SetBitrate(value int) error {
...
func (e *AvencTruehd) GetBufsize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTruehd) SetBufsize(value int) error {
...
func (e *AvencTruehd) GetChannelLayout() (uint64, error) {
	var value uint64
	var ok bool
...
func (e *AvencTruehd) SetChannelLayout(value uint64) error {
...
func (e *AvencTruehd) GetCompressionLevel() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTruehd) SetCompressionLevel(value int) error {
...
func (e *AvencTruehd) GetCutoff() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTruehd) SetCutoff(value int) error {
...
func (e *AvencTruehd) GetDebug() (interface{}, error) {
	return e.Element.GetProperty("debug")
}

func (e *AvencTruehd) SetDebug(value interface{}) error {
...
func (e *AvencTruehd) GetDumpSeparator() (string, error) {
	var value string
	var ok bool
...
func (e *AvencTruehd) SetDumpSeparator(value string) error {
...
func (e *AvencTruehd) GetErrDetect() (interface{}, error) {
	return e.Element.GetProperty("err-detect")
}

func (e *AvencTruehd) SetErrDetect(value interface{}) error {
...
func (e *AvencTruehd) GetExportSideData() (interface{}, error) {
	return e.Element.GetProperty("export-side-data")
}

func (e *AvencTruehd) SetExportSideData(value interface{}) error {
...
func (e *AvencTruehd) GetFlags() (interface{}, error) {
	return e.Element.GetProperty("flags")
}

func (e *AvencTruehd) SetFlags(value interface{}) error {
...
func (e *AvencTruehd) GetFlags2() (interface{}, error) {
	return e.Element.GetProperty("flags2")
}

func (e *AvencTruehd) SetFlags2(value interface{}) error {
...
func (e *AvencTruehd) GetFrameSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTruehd) SetFrameSize(value int) error {
...
func (e *AvencTruehd) GetGlobalQuality() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTruehd) SetGlobalQuality(value int) error {
...
func (e *AvencTruehd) GetMaxPixels() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencTruehd) SetMaxPixels(value int64) error {
...
func (e *AvencTruehd) GetMaxPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTruehd) SetMaxPredictionOrder(value int) error {
...
func (e *AvencTruehd) GetMaxSamples() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencTruehd) SetMaxSamples(value int64) error {
...
func (e *AvencTruehd) GetMaxrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencTruehd) SetMaxrate(value int64) error {
...
func (e *AvencTruehd) GetMinPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTruehd) SetMinPredictionOrder(value int) error {
...
func (e *AvencTruehd) GetMinrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencTruehd) SetMinrate(value int64) error {
...
func (e *AvencTruehd) GetSideDataOnlyPackets() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencTruehd) SetSideDataOnlyPackets(value bool) error {
...
func (e *AvencTruehd) GetStrict() (interface{}, error) {
	return e.Element.GetProperty("strict")
}

func (e *AvencTruehd) SetStrict(value interface{}) error {
...
func (e *AvencTruehd) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvencTruehd) SetThreadType(value interface{}) error {
...
func (e *AvencTruehd) GetThreads() (interface{}, error) {
	return e.Element.GetProperty("threads")
}

func (e *AvencTruehd) SetThreads(value interface{}) error {
...
func (e *AvencTruehd) GetTicksPerFrame() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTruehd) SetTicksPerFrame(value int) error {
...
func (e *AvencTruehd) GetTrellis() (int, error) {
	var value int
	var ok bool
...
func (e *AvencTruehd) SetTrellis(value int) error {
