...
type AvencAdpcmSwf struct {
	Element *gst.Element
}

func NewAvencAdpcmSwf() (*AvencAdpcmSwf, error) {
	e, err := gst.NewElement("avenc_adpcm_swf")
	if err != nil {
		return nil, err
	}
	return &AvencAdpcmSwf{Element: e}, nil
}

func NewAvencAdpcmSwfWithName(name string) (*AvencAdpcmSwf, error) {
	e, err := gst.NewElementWithName("avenc_adpcm_swf", name)
	if err != nil {
		return nil, err
	}
	return &AvencAdpcmSwf{Element: e}, nil
...
func (e *AvencAdpcmSwf) GetAc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmSwf) SetAc(value int) error {
...
func (e *AvencAdpcmSwf) GetAr() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmSwf) SetAr(value int) error {
...
func (e *AvencAdpcmSwf) GetAudioServiceType() (interface{}, error) {
	return e.Element.GetProperty("audio-service-type")
}

func (e *AvencAdpcmSwf) SetAudioServiceType(value interface{}) error {
...
func (e *AvencAdpcmSwf) GetBitrate() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmSwf) SetBitrate(value int) error {
...
func (e *AvencAdpcmSwf) GetBlockSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmSwf) SetBlockSize(value int) error {
...
func (e *AvencAdpcmSwf) GetBufsize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmSwf) SetBufsize(value int) error {
...
func (e *AvencAdpcmSwf) GetChannelLayout() (uint64, error) {
	var value uint64
	var ok bool
...
func (e *AvencAdpcmSwf) SetChannelLayout(value uint64) error {
...
func (e *AvencAdpcmSwf) GetCompressionLevel() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmSwf) SetCompressionLevel(value int) error {
...
func (e *AvencAdpcmSwf) GetCutoff() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmSwf) SetCutoff(value int) error {
...
func (e *AvencAdpcmSwf) GetDebug() (interface{}, error) {
	return e.Element.GetProperty("debug")
}

func (e *AvencAdpcmSwf) SetDebug(value interface{}) error {
...
func (e *AvencAdpcmSwf) GetDumpSeparator() (string, error) {
	var value string
	var ok bool
...
func (e *AvencAdpcmSwf) SetDumpSeparator(value string) error {
...
func (e *AvencAdpcmSwf) GetErrDetect() (interface{}, error) {
	return e.Element.GetProperty("err-detect")
}

func (e *AvencAdpcmSwf) SetErrDetect(value interface{}) error {
...
func (e *AvencAdpcmSwf) GetExportSideData() (interface{}, error) {
	return e.Element.GetProperty("export-side-data")
}

func (e *AvencAdpcmSwf) SetExportSideData(value interface{}) error {
...
func (e *AvencAdpcmSwf) GetFlags() (interface{}, error) {
	return e.Element.GetProperty("flags")
}

func (e *AvencAdpcmSwf) SetFlags(value interface{}) error {
...
func (e *AvencAdpcmSwf) GetFlags2() (interface{}, error) {
	return e.Element.GetProperty("flags2")
}

func (e *AvencAdpcmSwf) SetFlags2(value interface{}) error {
...
func (e *AvencAdpcmSwf) GetFrameSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmSwf) SetFrameSize(value int) error {
...
func (e *AvencAdpcmSwf) GetGlobalQuality() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmSwf) SetGlobalQuality(value int) error {
...
func (e *AvencAdpcmSwf) GetMaxPixels() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAdpcmSwf) SetMaxPixels(value int64) error {
...
func (e *AvencAdpcmSwf) GetMaxPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmSwf) SetMaxPredictionOrder(value int) error {
...
func (e *AvencAdpcmSwf) GetMaxSamples() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAdpcmSwf) SetMaxSamples(value int64) error {
...
func (e *AvencAdpcmSwf) GetMaxrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAdpcmSwf) SetMaxrate(value int64) error {
...
func (e *AvencAdpcmSwf) GetMinPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmSwf) SetMinPredictionOrder(value int) error {
...
func (e *AvencAdpcmSwf) GetMinrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAdpcmSwf) SetMinrate(value int64) error {
...
func (e *AvencAdpcmSwf) GetSideDataOnlyPackets() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencAdpcmSwf) SetSideDataOnlyPackets(value bool) error {
...
func (e *AvencAdpcmSwf) GetStrict() (interface{}, error) {
	return e.Element.GetProperty("strict")
}

func (e *AvencAdpcmSwf) SetStrict(value interface{}) error {
...
func (e *AvencAdpcmSwf) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvencAdpcmSwf) SetThreadType(value interface{}) error {
...
func (e *AvencAdpcmSwf) GetThreads() (interface{}, error) {
	return e.Element.GetProperty("threads")
}

func (e *AvencAdpcmSwf) SetThreads(value interface{}) error {
...
func (e *AvencAdpcmSwf) GetTicksPerFrame() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmSwf) SetTicksPerFrame(value int) error {
...
func (e *AvencAdpcmSwf) GetTrellis() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmSwf) SetTrellis(value int) error {
