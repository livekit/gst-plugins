...
type AvdecVp8 struct {
	Element *gst.Element
}

func NewAvdecVp8() (*AvdecVp8, error) {
	e, err := gst.NewElement("avdec_vp8")
	if err != nil {
		return nil, err
	}
	return &AvdecVp8{Element: e}, nil
}

func NewAvdecVp8WithName(name string) (*AvdecVp8, error) {
	e, err := gst.NewElementWithName("avdec_vp8", name)
	if err != nil {
		return nil, err
	}
	return &AvdecVp8{Element: e}, nil
...
func (e *AvdecVp8) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecVp8) SetDebugMv(value bool) error {
...
func (e *AvdecVp8) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecVp8) SetDirectRendering(value bool) error {
...
func (e *AvdecVp8) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecVp8) SetLowres(value interface{}) error {
...
func (e *AvdecVp8) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecVp8) SetMaxThreads(value int) error {
...
func (e *AvdecVp8) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecVp8) SetOutputCorrupt(value bool) error {
...
func (e *AvdecVp8) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecVp8) SetSkipFrame(value interface{}) error {
...
func (e *AvdecVp8) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecVp8) SetThreadType(value interface{}) error {
