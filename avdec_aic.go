...
type AvdecAic struct {
	Element *gst.Element
}

func NewAvdecAic() (*AvdecAic, error) {
	e, err := gst.NewElement("avdec_aic")
	if err != nil {
		return nil, err
	}
	return &AvdecAic{Element: e}, nil
}

func NewAvdecAicWithName(name string) (*AvdecAic, error) {
	e, err := gst.NewElementWithName("avdec_aic", name)
	if err != nil {
		return nil, err
	}
	return &AvdecAic{Element: e}, nil
...
func (e *AvdecAic) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecAic) SetDebugMv(value bool) error {
...
func (e *AvdecAic) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecAic) SetDirectRendering(value bool) error {
...
func (e *AvdecAic) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecAic) SetLowres(value interface{}) error {
...
func (e *AvdecAic) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecAic) SetMaxThreads(value int) error {
...
func (e *AvdecAic) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecAic) SetOutputCorrupt(value bool) error {
...
func (e *AvdecAic) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecAic) SetSkipFrame(value interface{}) error {
...
func (e *AvdecAic) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecAic) SetThreadType(value interface{}) error {
