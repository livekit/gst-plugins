...
func NewAvdecVb() (*AvdecVb, error) {
	e, err := gst.NewElement("avdec_vb")
	if err != nil {
		return nil, err
	}
	return &AvdecVb{Element: e}, nil
}

func NewAvdecVbWithName(name string) (*AvdecVb, error) {
	e, err := gst.NewElementWithName("avdec_vb", name)
	if err != nil {
		return nil, err
	}
	return &AvdecVb{Element: e}, nil
...
func (e *AvdecVb) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecVb) SetDebugMv(value bool) error {
...
func (e *AvdecVb) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecVb) SetDirectRendering(value bool) error {
...
func (e *AvdecVb) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecVb) SetLowres(value interface{}) error {
...
func (e *AvdecVb) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecVb) SetOutputCorrupt(value bool) error {
...
func (e *AvdecVb) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecVb) SetSkipFrame(value interface{}) error {
