...
type AvdecPsd struct {
	Element *gst.Element
}

func NewAvdecPsd() (*AvdecPsd, error) {
	e, err := gst.NewElement("avdec_psd")
	if err != nil {
		return nil, err
	}
	return &AvdecPsd{Element: e}, nil
}

func NewAvdecPsdWithName(name string) (*AvdecPsd, error) {
	e, err := gst.NewElementWithName("avdec_psd", name)
	if err != nil {
		return nil, err
	}
	return &AvdecPsd{Element: e}, nil
...
func (e *AvdecPsd) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecPsd) SetDebugMv(value bool) error {
...
func (e *AvdecPsd) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecPsd) SetDirectRendering(value bool) error {
...
func (e *AvdecPsd) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecPsd) SetLowres(value interface{}) error {
...
func (e *AvdecPsd) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecPsd) SetMaxThreads(value int) error {
...
func (e *AvdecPsd) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecPsd) SetOutputCorrupt(value bool) error {
...
func (e *AvdecPsd) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecPsd) SetSkipFrame(value interface{}) error {
...
func (e *AvdecPsd) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecPsd) SetThreadType(value interface{}) error {
