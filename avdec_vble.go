...
type AvdecVble struct {
	Element *gst.Element
}

func NewAvdecVble() (*AvdecVble, error) {
	e, err := gst.NewElement("avdec_vble")
	if err != nil {
		return nil, err
	}
	return &AvdecVble{Element: e}, nil
}

func NewAvdecVbleWithName(name string) (*AvdecVble, error) {
	e, err := gst.NewElementWithName("avdec_vble", name)
	if err != nil {
		return nil, err
	}
	return &AvdecVble{Element: e}, nil
...
func (e *AvdecVble) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecVble) SetDebugMv(value bool) error {
...
func (e *AvdecVble) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecVble) SetDirectRendering(value bool) error {
...
func (e *AvdecVble) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecVble) SetLowres(value interface{}) error {
...
func (e *AvdecVble) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecVble) SetMaxThreads(value int) error {
...
func (e *AvdecVble) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecVble) SetOutputCorrupt(value bool) error {
...
func (e *AvdecVble) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecVble) SetSkipFrame(value interface{}) error {
...
func (e *AvdecVble) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecVble) SetThreadType(value interface{}) error {
