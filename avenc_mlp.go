...
type AvencMlp struct {
	Element *gst.Element
}

func NewAvencMlp() (*AvencMlp, error) {
	e, err := gst.NewElement("avenc_mlp")
	if err != nil {
		return nil, err
	}
	return &AvencMlp{Element: e}, nil
}

func NewAvencMlpWithName(name string) (*AvencMlp, error) {
	e, err := gst.NewElementWithName("avenc_mlp", name)
	if err != nil {
		return nil, err
	}
	return &AvencMlp{Element: e}, nil
...
func (e *AvencMlp) GetAc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencMlp) SetAc(value int) error {
...
func (e *AvencMlp) GetAr() (int, error) {
	var value int
	var ok bool
...
func (e *AvencMlp) SetAr(value int) error {
...
func (e *AvencMlp) GetAudioServiceType() (interface{}, error) {
	return e.Element.GetProperty("audio-service-type")
}

func (e *AvencMlp) SetAudioServiceType(value interface{}) error {
...
func (e *AvencMlp) GetBitrate() (int, error) {
	var value int
	var ok bool
...
func (e *AvencMlp) SetBitrate(value int) error {
...
func (e *AvencMlp) GetBufsize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencMlp) SetBufsize(value int) error {
...
func (e *AvencMlp) GetChannelLayout() (uint64, error) {
	var value uint64
	var ok bool
...
func (e *AvencMlp) SetChannelLayout(value uint64) error {
...
func (e *AvencMlp) GetCompressionLevel() (int, error) {
	var value int
	var ok bool
...
func (e *AvencMlp) SetCompressionLevel(value int) error {
...
func (e *AvencMlp) GetCutoff() (int, error) {
	var value int
	var ok bool
...
func (e *AvencMlp) SetCutoff(value int) error {
...
func (e *AvencMlp) GetDebug() (interface{}, error) {
	return e.Element.GetProperty("debug")
}

func (e *AvencMlp) SetDebug(value interface{}) error {
...
func (e *AvencMlp) GetDumpSeparator() (string, error) {
	var value string
	var ok bool
...
func (e *AvencMlp) SetDumpSeparator(value string) error {
...
func (e *AvencMlp) GetErrDetect() (interface{}, error) {
	return e.Element.GetProperty("err-detect")
}

func (e *AvencMlp) SetErrDetect(value interface{}) error {
...
func (e *AvencMlp) GetExportSideData() (interface{}, error) {
	return e.Element.GetProperty("export-side-data")
}

func (e *AvencMlp) SetExportSideData(value interface{}) error {
...
func (e *AvencMlp) GetFlags() (interface{}, error) {
	return e.Element.GetProperty("flags")
}

func (e *AvencMlp) SetFlags(value interface{}) error {
...
func (e *AvencMlp) GetFlags2() (interface{}, error) {
	return e.Element.GetProperty("flags2")
}

func (e *AvencMlp) SetFlags2(value interface{}) error {
...
func (e *AvencMlp) GetFrameSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencMlp) SetFrameSize(value int) error {
...
func (e *AvencMlp) GetGlobalQuality() (int, error) {
	var value int
	var ok bool
...
func (e *AvencMlp) SetGlobalQuality(value int) error {
...
func (e *AvencMlp) GetMaxPixels() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencMlp) SetMaxPixels(value int64) error {
...
func (e *AvencMlp) GetMaxPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencMlp) SetMaxPredictionOrder(value int) error {
...
func (e *AvencMlp) GetMaxSamples() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencMlp) SetMaxSamples(value int64) error {
...
func (e *AvencMlp) GetMaxrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencMlp) SetMaxrate(value int64) error {
...
func (e *AvencMlp) GetMinPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencMlp) SetMinPredictionOrder(value int) error {
...
func (e *AvencMlp) GetMinrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencMlp) SetMinrate(value int64) error {
...
func (e *AvencMlp) GetSideDataOnlyPackets() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencMlp) SetSideDataOnlyPackets(value bool) error {
...
func (e *AvencMlp) GetStrict() (interface{}, error) {
	return e.Element.GetProperty("strict")
}

func (e *AvencMlp) SetStrict(value interface{}) error {
...
func (e *AvencMlp) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvencMlp) SetThreadType(value interface{}) error {
...
func (e *AvencMlp) GetThreads() (interface{}, error) {
	return e.Element.GetProperty("threads")
}

func (e *AvencMlp) SetThreads(value interface{}) error {
...
func (e *AvencMlp) GetTicksPerFrame() (int, error) {
	var value int
	var ok bool
...
func (e *AvencMlp) SetTicksPerFrame(value int) error {
...
func (e *AvencMlp) GetTrellis() (int, error) {
	var value int
	var ok bool
...
func (e *AvencMlp) SetTrellis(value int) error {
