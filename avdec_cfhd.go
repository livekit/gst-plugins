...
type AvdecCfhd struct {
	Element *gst.Element
}

func NewAvdecCfhd() (*AvdecCfhd, error) {
	e, err := gst.NewElement("avdec_cfhd")
	if err != nil {
		return nil, err
	}
	return &AvdecCfhd{Element: e}, nil
}

func NewAvdecCfhdWithName(name string) (*AvdecCfhd, error) {
	e, err := gst.NewElementWithName("avdec_cfhd", name)
	if err != nil {
		return nil, err
	}
	return &AvdecCfhd{Element: e}, nil
...
func (e *AvdecCfhd) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecCfhd) SetDebugMv(value bool) error {
...
func (e *AvdecCfhd) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecCfhd) SetDirectRendering(value bool) error {
...
func (e *AvdecCfhd) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecCfhd) SetLowres(value interface{}) error {
...
func (e *AvdecCfhd) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecCfhd) SetMaxThreads(value int) error {
...
func (e *AvdecCfhd) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecCfhd) SetOutputCorrupt(value bool) error {
...
func (e *AvdecCfhd) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecCfhd) SetSkipFrame(value interface{}) error {
...
func (e *AvdecCfhd) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecCfhd) SetThreadType(value interface{}) error {
