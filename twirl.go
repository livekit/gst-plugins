...
func NewTwirl() (*Twirl, error) {
	e, err := gst.NewElement("twirl")
	if err != nil {
		return nil, err
	}
	return &Twirl{GstBaseTransform: &base.GstBaseTransform{Element: e}}, nil
}

func NewTwirlWithName(name string) (*Twirl, error) {
...
func (e *Twirl) GetAngle() (float64, error) {
	var value float64
	var ok bool
...
func (e *Twirl) SetAngle(value float64) error {
