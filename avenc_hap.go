...
type AvencHap struct {
	Element *gst.Element
}

func NewAvencHap() (*AvencHap, error) {
	e, err := gst.NewElement("avenc_hap")
	if err != nil {
		return nil, err
	}
	return &AvencHap{Element: e}, nil
}

func NewAvencHapWithName(name string) (*AvencHap, error) {
	e, err := gst.NewElementWithName("avenc_hap", name)
	if err != nil {
		return nil, err
	}
	return &AvencHap{Element: e}, nil
...
func (e *AvencHap) GetBQfactor() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencHap) SetBQfactor(value float32) error {
...
func (e *AvencHap) GetBQoffset() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencHap) SetBQoffset(value float32) error {
...
func (e *AvencHap) GetBSensitivity() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetBSensitivity(value int) error {
...
func (e *AvencHap) GetBStrategy() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetBStrategy(value int) error {
...
func (e *AvencHap) GetBidirRefine() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetBidirRefine(value int) error {
...
func (e *AvencHap) GetBitrate() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetBitrate(value int) error {
...
func (e *AvencHap) GetBitrateTolerance() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetBitrateTolerance(value int) error {
...
func (e *AvencHap) GetBrdScale() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetBrdScale(value int) error {
...
func (e *AvencHap) GetBufsize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetBufsize(value int) error {
...
func (e *AvencHap) GetChromaSampleLocation() (interface{}, error) {
	return e.Element.GetProperty("chroma-sample-location")
}

func (e *AvencHap) SetChromaSampleLocation(value interface{}) error {
...
func (e *AvencHap) GetChromaoffset() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetChromaoffset(value int) error {
	return e.Element.SetProperty("chromaoffset", value)
}

// chunks (int)
//
// chunk count (Private codec option)

func (e *AvencHap) GetChunks() (int, error) {
	var value int
	var ok bool
	v, err := e.Element.GetProperty("chunks")
	if err != nil {
		return value, err
	}
	value, ok = v.(int)
...
func (e *AvencHap) SetChunks(value int) error {
	return e.Element.SetProperty("chunks", value)
}
...
func (e *AvencHap) GetCmp() (interface{}, error) {
	return e.Element.GetProperty("cmp")
}

func (e *AvencHap) SetCmp(value interface{}) error {
...
func (e *AvencHap) GetCoder() (interface{}, error) {
	return e.Element.GetProperty("coder")
}

func (e *AvencHap) SetCoder(value interface{}) error {
...
func (e *AvencHap) GetCompressionLevel() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetCompressionLevel(value int) error {
	return e.Element.SetProperty("compression-level", value)
}

// compressor (GstHapEncoderCompressor)
//
// second-stage compressor (Private codec option)

func (e *AvencHap) GetCompressor() (interface{}, error) {
	return e.Element.GetProperty("compressor")
}

func (e *AvencHap) SetCompressor(value interface{}) error {
	return e.Element.SetProperty("compressor", value)
}
...
func (e *AvencHap) GetContext() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetContext(value int) error {
...
func (e *AvencHap) GetDarkMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencHap) SetDarkMask(value float32) error {
...
func (e *AvencHap) GetDc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetDc(value int) error {
...
func (e *AvencHap) GetDct() (interface{}, error) {
	return e.Element.GetProperty("dct")
}

func (e *AvencHap) SetDct(value interface{}) error {
...
func (e *AvencHap) GetDebug() (interface{}, error) {
	return e.Element.GetProperty("debug")
}

func (e *AvencHap) SetDebug(value interface{}) error {
...
func (e *AvencHap) GetDiaSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetDiaSize(value int) error {
...
func (e *AvencHap) GetDumpSeparator() (string, error) {
	var value string
	var ok bool
...
func (e *AvencHap) SetDumpSeparator(value string) error {
...
func (e *AvencHap) GetErrDetect() (interface{}, error) {
	return e.Element.GetProperty("err-detect")
}

func (e *AvencHap) SetErrDetect(value interface{}) error {
...
func (e *AvencHap) GetExportSideData() (interface{}, error) {
	return e.Element.GetProperty("export-side-data")
}

func (e *AvencHap) SetExportSideData(value interface{}) error {
...
func (e *AvencHap) GetFieldOrder() (interface{}, error) {
	return e.Element.GetProperty("field-order")
}

func (e *AvencHap) SetFieldOrder(value interface{}) error {
...
func (e *AvencHap) GetFlags() (interface{}, error) {
	return e.Element.GetProperty("flags")
}

func (e *AvencHap) SetFlags(value interface{}) error {
...
func (e *AvencHap) GetFlags2() (interface{}, error) {
	return e.Element.GetProperty("flags2")
}

func (e *AvencHap) SetFlags2(value interface{}) error {
	return e.Element.SetProperty("flags2", value)
}

// format (GstHapEncoderFormat)
//
// (null) (Private codec option)

func (e *AvencHap) GetFormat() (interface{}, error) {
	return e.Element.GetProperty("format")
}

func (e *AvencHap) SetFormat(value interface{}) error {
...
func (e *AvencHap) GetGlobalQuality() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetGlobalQuality(value int) error {
...
func (e *AvencHap) GetGopSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetGopSize(value int) error {
...
func (e *AvencHap) GetIQfactor() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencHap) SetIQfactor(value float32) error {
...
func (e *AvencHap) GetIQoffset() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencHap) SetIQoffset(value float32) error {
...
func (e *AvencHap) GetIdct() (interface{}, error) {
	return e.Element.GetProperty("idct")
}

func (e *AvencHap) SetIdct(value interface{}) error {
...
func (e *AvencHap) GetIldctcmp() (interface{}, error) {
	return e.Element.GetProperty("ildctcmp")
}

func (e *AvencHap) SetIldctcmp(value interface{}) error {
...
func (e *AvencHap) GetKeyintMin() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetKeyintMin(value int) error {
...
func (e *AvencHap) GetLastPred() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetLastPred(value int) error {
...
func (e *AvencHap) GetLumiMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencHap) SetLumiMask(value float32) error {
...
func (e *AvencHap) GetMaxBframes() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetMaxBframes(value int) error {
...
func (e *AvencHap) GetMaxPixels() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencHap) SetMaxPixels(value int64) error {
...
func (e *AvencHap) GetMaxrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencHap) SetMaxrate(value int64) error {
...
func (e *AvencHap) GetMbcmp() (interface{}, error) {
	return e.Element.GetProperty("mbcmp")
}

func (e *AvencHap) SetMbcmp(value interface{}) error {
...
func (e *AvencHap) GetMbd() (interface{}, error) {
	return e.Element.GetProperty("mbd")
}

func (e *AvencHap) SetMbd(value interface{}) error {
...
func (e *AvencHap) GetMblmax() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetMblmax(value int) error {
...
func (e *AvencHap) GetMblmin() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetMblmin(value int) error {
...
func (e *AvencHap) GetMeRange() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetMeRange(value int) error {
...
func (e *AvencHap) GetMepc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetMepc(value int) error {
...
func (e *AvencHap) GetMinForceKeyUnitInterval() (uint64, error) {
	var value uint64
	var ok bool
...
func (e *AvencHap) SetMinForceKeyUnitInterval(value uint64) error {
...
func (e *AvencHap) GetMinrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencHap) SetMinrate(value int64) error {
...
func (e *AvencHap) GetMpegQuant() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetMpegQuant(value int) error {
...
func (e *AvencHap) GetMultipassCacheFile() (string, error) {
	var value string
	var ok bool
...
func (e *AvencHap) SetMultipassCacheFile(value string) error {
...
func (e *AvencHap) GetMv0Threshold() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetMv0Threshold(value int) error {
...
func (e *AvencHap) GetNr() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetNr(value int) error {
...
func (e *AvencHap) GetNssew() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetNssew(value int) error {
...
func (e *AvencHap) GetPMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencHap) SetPMask(value float32) error {
...
func (e *AvencHap) GetPass() (interface{}, error) {
	return e.Element.GetProperty("pass")
}

func (e *AvencHap) SetPass(value interface{}) error {
...
func (e *AvencHap) GetPreDiaSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetPreDiaSize(value int) error {
...
func (e *AvencHap) GetPrecmp() (interface{}, error) {
	return e.Element.GetProperty("precmp")
}

func (e *AvencHap) SetPrecmp(value interface{}) error {
...
func (e *AvencHap) GetPred() (interface{}, error) {
	return e.Element.GetProperty("pred")
}

func (e *AvencHap) SetPred(value interface{}) error {
...
func (e *AvencHap) GetPreme() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetPreme(value int) error {
...
func (e *AvencHap) GetPs() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetPs(value int) error {
...
func (e *AvencHap) GetQblur() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencHap) SetQblur(value float32) error {
...
func (e *AvencHap) GetQcomp() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencHap) SetQcomp(value float32) error {
...
func (e *AvencHap) GetQdiff() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetQdiff(value int) error {
...
func (e *AvencHap) GetQmax() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetQmax(value int) error {
...
func (e *AvencHap) GetQmin() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetQmin(value int) error {
...
func (e *AvencHap) GetQos() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencHap) SetQos(value bool) error {
...
func (e *AvencHap) GetQuantizer() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencHap) SetQuantizer(value float32) error {
...
func (e *AvencHap) GetRcInitOccupancy() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetRcInitOccupancy(value int) error {
...
func (e *AvencHap) GetRcMaxVbvUse() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencHap) SetRcMaxVbvUse(value float32) error {
...
func (e *AvencHap) GetRcMinVbvUse() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencHap) SetRcMinVbvUse(value float32) error {
...
func (e *AvencHap) GetRefs() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetRefs(value int) error {
...
func (e *AvencHap) GetScThreshold() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetScThreshold(value int) error {
...
func (e *AvencHap) GetScplxMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencHap) SetScplxMask(value float32) error {
...
func (e *AvencHap) GetSideDataOnlyPackets() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencHap) SetSideDataOnlyPackets(value bool) error {
...
func (e *AvencHap) GetSkipExp() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetSkipExp(value int) error {
...
func (e *AvencHap) GetSkipFactor() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetSkipFactor(value int) error {
...
func (e *AvencHap) GetSkipThreshold() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetSkipThreshold(value int) error {
...
func (e *AvencHap) GetSkipcmp() (interface{}, error) {
	return e.Element.GetProperty("skipcmp")
}

func (e *AvencHap) SetSkipcmp(value interface{}) error {
...
func (e *AvencHap) GetSlices() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetSlices(value int) error {
...
func (e *AvencHap) GetStrict() (interface{}, error) {
	return e.Element.GetProperty("strict")
}

func (e *AvencHap) SetStrict(value interface{}) error {
...
func (e *AvencHap) GetSubcmp() (interface{}, error) {
	return e.Element.GetProperty("subcmp")
}

func (e *AvencHap) SetSubcmp(value interface{}) error {
...
func (e *AvencHap) GetSubq() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetSubq(value int) error {
...
func (e *AvencHap) GetTcplxMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencHap) SetTcplxMask(value float32) error {
...
func (e *AvencHap) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvencHap) SetThreadType(value interface{}) error {
...
func (e *AvencHap) GetThreads() (interface{}, error) {
	return e.Element.GetProperty("threads")
}

func (e *AvencHap) SetThreads(value interface{}) error {
...
func (e *AvencHap) GetTicksPerFrame() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetTicksPerFrame(value int) error {
...
func (e *AvencHap) GetTimecodeFrameStart() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencHap) SetTimecodeFrameStart(value int64) error {
...
func (e *AvencHap) GetTrellis() (int, error) {
	var value int
	var ok bool
...
func (e *AvencHap) SetTrellis(value int) error {
	return e.Element.SetProperty("trellis", value)
}

// ----- Constants -----

type HapEncoderCompressor string

const (
	HapEncoderCompressorNone HapEncoderCompressor = "none" // none (160) – None
	HapEncoderCompressorSnappy HapEncoderCompressor = "snappy" // snappy (176) – Snappy
)

type HapEncoderFormat string

const (
	HapEncoderFormatHap HapEncoderFormat = "hap" // hap (11) – Hap 1 (DXT1 textures)
	HapEncoderFormatHapAlpha HapEncoderFormat = "hap_alpha" // hap_alpha (14) – Hap Alpha (DXT5 textures)
	HapEncoderFormatHapQ HapEncoderFormat = "hap_q" // hap_q (15) – Hap Q (DXT5-YCoCg textures)
)
