...
type AvdecCri struct {
	Element *gst.Element
}

func NewAvdecCri() (*AvdecCri, error) {
	e, err := gst.NewElement("avdec_cri")
	if err != nil {
		return nil, err
	}
	return &AvdecCri{Element: e}, nil
}

func NewAvdecCriWithName(name string) (*AvdecCri, error) {
	e, err := gst.NewElementWithName("avdec_cri", name)
	if err != nil {
		return nil, err
	}
	return &AvdecCri{Element: e}, nil
...
func (e *AvdecCri) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecCri) SetDebugMv(value bool) error {
...
func (e *AvdecCri) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecCri) SetDirectRendering(value bool) error {
...
func (e *AvdecCri) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecCri) SetLowres(value interface{}) error {
...
func (e *AvdecCri) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecCri) SetMaxThreads(value int) error {
...
func (e *AvdecCri) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecCri) SetOutputCorrupt(value bool) error {
...
func (e *AvdecCri) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecCri) SetSkipFrame(value interface{}) error {
...
func (e *AvdecCri) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecCri) SetThreadType(value interface{}) error {
