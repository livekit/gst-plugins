...
func NewAvdecH264() (*AvdecH264, error) {
	e, err := gst.NewElement("avdec_h264")
	if err != nil {
		return nil, err
	}
	return &AvdecH264{Element: e}, nil
}

func NewAvdecH264WithName(name string) (*AvdecH264, error) {
	e, err := gst.NewElementWithName("avdec_h264", name)
	if err != nil {
		return nil, err
	}
	return &AvdecH264{Element: e}, nil
...
func (e *AvdecH264) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecH264) SetDebugMv(value bool) error {
...
func (e *AvdecH264) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecH264) SetDirectRendering(value bool) error {
...
func (e *AvdecH264) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecH264) SetLowres(value interface{}) error {
...
func (e *AvdecH264) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecH264) SetMaxThreads(value int) error {
...
func (e *AvdecH264) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecH264) SetOutputCorrupt(value bool) error {
...
func (e *AvdecH264) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecH264) SetSkipFrame(value interface{}) error {
...
func (e *AvdecH264) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecH264) SetThreadType(value interface{}) error {
