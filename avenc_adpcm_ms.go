...
type AvencAdpcmMs struct {
	Element *gst.Element
}

func NewAvencAdpcmMs() (*AvencAdpcmMs, error) {
	e, err := gst.NewElement("avenc_adpcm_ms")
	if err != nil {
		return nil, err
	}
	return &AvencAdpcmMs{Element: e}, nil
}

func NewAvencAdpcmMsWithName(name string) (*AvencAdpcmMs, error) {
	e, err := gst.NewElementWithName("avenc_adpcm_ms", name)
	if err != nil {
		return nil, err
	}
	return &AvencAdpcmMs{Element: e}, nil
...
func (e *AvencAdpcmMs) GetAc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmMs) SetAc(value int) error {
...
func (e *AvencAdpcmMs) GetAr() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmMs) SetAr(value int) error {
...
func (e *AvencAdpcmMs) GetAudioServiceType() (interface{}, error) {
	return e.Element.GetProperty("audio-service-type")
}

func (e *AvencAdpcmMs) SetAudioServiceType(value interface{}) error {
...
func (e *AvencAdpcmMs) GetBitrate() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmMs) SetBitrate(value int) error {
...
func (e *AvencAdpcmMs) GetBlockSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmMs) SetBlockSize(value int) error {
...
func (e *AvencAdpcmMs) GetBufsize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmMs) SetBufsize(value int) error {
...
func (e *AvencAdpcmMs) GetChannelLayout() (uint64, error) {
	var value uint64
	var ok bool
...
func (e *AvencAdpcmMs) SetChannelLayout(value uint64) error {
...
func (e *AvencAdpcmMs) GetCompressionLevel() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmMs) SetCompressionLevel(value int) error {
...
func (e *AvencAdpcmMs) GetCutoff() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmMs) SetCutoff(value int) error {
...
func (e *AvencAdpcmMs) GetDebug() (interface{}, error) {
	return e.Element.GetProperty("debug")
}

func (e *AvencAdpcmMs) SetDebug(value interface{}) error {
...
func (e *AvencAdpcmMs) GetDumpSeparator() (string, error) {
	var value string
	var ok bool
...
func (e *AvencAdpcmMs) SetDumpSeparator(value string) error {
...
func (e *AvencAdpcmMs) GetErrDetect() (interface{}, error) {
	return e.Element.GetProperty("err-detect")
}

func (e *AvencAdpcmMs) SetErrDetect(value interface{}) error {
...
func (e *AvencAdpcmMs) GetExportSideData() (interface{}, error) {
	return e.Element.GetProperty("export-side-data")
}

func (e *AvencAdpcmMs) SetExportSideData(value interface{}) error {
...
func (e *AvencAdpcmMs) GetFlags() (interface{}, error) {
	return e.Element.GetProperty("flags")
}

func (e *AvencAdpcmMs) SetFlags(value interface{}) error {
...
func (e *AvencAdpcmMs) GetFlags2() (interface{}, error) {
	return e.Element.GetProperty("flags2")
}

func (e *AvencAdpcmMs) SetFlags2(value interface{}) error {
...
func (e *AvencAdpcmMs) GetFrameSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmMs) SetFrameSize(value int) error {
...
func (e *AvencAdpcmMs) GetGlobalQuality() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmMs) SetGlobalQuality(value int) error {
...
func (e *AvencAdpcmMs) GetMaxPixels() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAdpcmMs) SetMaxPixels(value int64) error {
...
func (e *AvencAdpcmMs) GetMaxPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmMs) SetMaxPredictionOrder(value int) error {
...
func (e *AvencAdpcmMs) GetMaxSamples() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAdpcmMs) SetMaxSamples(value int64) error {
...
func (e *AvencAdpcmMs) GetMaxrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAdpcmMs) SetMaxrate(value int64) error {
...
func (e *AvencAdpcmMs) GetMinPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmMs) SetMinPredictionOrder(value int) error {
...
func (e *AvencAdpcmMs) GetMinrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAdpcmMs) SetMinrate(value int64) error {
...
func (e *AvencAdpcmMs) GetSideDataOnlyPackets() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencAdpcmMs) SetSideDataOnlyPackets(value bool) error {
...
func (e *AvencAdpcmMs) GetStrict() (interface{}, error) {
	return e.Element.GetProperty("strict")
}

func (e *AvencAdpcmMs) SetStrict(value interface{}) error {
...
func (e *AvencAdpcmMs) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvencAdpcmMs) SetThreadType(value interface{}) error {
...
func (e *AvencAdpcmMs) GetThreads() (interface{}, error) {
	return e.Element.GetProperty("threads")
}

func (e *AvencAdpcmMs) SetThreads(value interface{}) error {
...
func (e *AvencAdpcmMs) GetTicksPerFrame() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmMs) SetTicksPerFrame(value int) error {
...
func (e *AvencAdpcmMs) GetTrellis() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmMs) SetTrellis(value int) error {
