...
type AvdecHymt struct {
	Element *gst.Element
}

func NewAvdecHymt() (*AvdecHymt, error) {
	e, err := gst.NewElement("avdec_hymt")
	if err != nil {
		return nil, err
	}
	return &AvdecHymt{Element: e}, nil
}

func NewAvdecHymtWithName(name string) (*AvdecHymt, error) {
	e, err := gst.NewElementWithName("avdec_hymt", name)
	if err != nil {
		return nil, err
	}
	return &AvdecHymt{Element: e}, nil
...
func (e *AvdecHymt) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecHymt) SetDebugMv(value bool) error {
...
func (e *AvdecHymt) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecHymt) SetDirectRendering(value bool) error {
...
func (e *AvdecHymt) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecHymt) SetLowres(value interface{}) error {
...
func (e *AvdecHymt) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecHymt) SetMaxThreads(value int) error {
...
func (e *AvdecHymt) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecHymt) SetOutputCorrupt(value bool) error {
...
func (e *AvdecHymt) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecHymt) SetSkipFrame(value interface{}) error {
...
func (e *AvdecHymt) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecHymt) SetThreadType(value interface{}) error {
