...
type AvdecVp3 struct {
	Element *gst.Element
}

func NewAvdecVp3() (*AvdecVp3, error) {
	e, err := gst.NewElement("avdec_vp3")
	if err != nil {
		return nil, err
	}
	return &AvdecVp3{Element: e}, nil
}

func NewAvdecVp3WithName(name string) (*AvdecVp3, error) {
	e, err := gst.NewElementWithName("avdec_vp3", name)
	if err != nil {
		return nil, err
	}
	return &AvdecVp3{Element: e}, nil
...
func (e *AvdecVp3) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecVp3) SetDebugMv(value bool) error {
...
func (e *AvdecVp3) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecVp3) SetDirectRendering(value bool) error {
...
func (e *AvdecVp3) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecVp3) SetLowres(value interface{}) error {
...
func (e *AvdecVp3) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecVp3) SetMaxThreads(value int) error {
...
func (e *AvdecVp3) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecVp3) SetOutputCorrupt(value bool) error {
...
func (e *AvdecVp3) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecVp3) SetSkipFrame(value interface{}) error {
...
func (e *AvdecVp3) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecVp3) SetThreadType(value interface{}) error {
