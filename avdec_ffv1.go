...
type AvdecFfv1 struct {
	Element *gst.Element
}

func NewAvdecFfv1() (*AvdecFfv1, error) {
	e, err := gst.NewElement("avdec_ffv1")
	if err != nil {
		return nil, err
	}
	return &AvdecFfv1{Element: e}, nil
}

func NewAvdecFfv1WithName(name string) (*AvdecFfv1, error) {
	e, err := gst.NewElementWithName("avdec_ffv1", name)
	if err != nil {
		return nil, err
	}
	return &AvdecFfv1{Element: e}, nil
...
func (e *AvdecFfv1) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecFfv1) SetDebugMv(value bool) error {
...
func (e *AvdecFfv1) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecFfv1) SetDirectRendering(value bool) error {
...
func (e *AvdecFfv1) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecFfv1) SetLowres(value interface{}) error {
...
func (e *AvdecFfv1) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecFfv1) SetMaxThreads(value int) error {
...
func (e *AvdecFfv1) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecFfv1) SetOutputCorrupt(value bool) error {
...
func (e *AvdecFfv1) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecFfv1) SetSkipFrame(value interface{}) error {
...
func (e *AvdecFfv1) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecFfv1) SetThreadType(value interface{}) error {
