...
type AvdecHqx struct {
	Element *gst.Element
}

func NewAvdecHqx() (*AvdecHqx, error) {
	e, err := gst.NewElement("avdec_hqx")
	if err != nil {
		return nil, err
	}
	return &AvdecHqx{Element: e}, nil
}

func NewAvdecHqxWithName(name string) (*AvdecHqx, error) {
	e, err := gst.NewElementWithName("avdec_hqx", name)
	if err != nil {
		return nil, err
	}
	return &AvdecHqx{Element: e}, nil
...
func (e *AvdecHqx) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecHqx) SetDebugMv(value bool) error {
...
func (e *AvdecHqx) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecHqx) SetDirectRendering(value bool) error {
...
func (e *AvdecHqx) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecHqx) SetLowres(value interface{}) error {
...
func (e *AvdecHqx) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecHqx) SetMaxThreads(value int) error {
...
func (e *AvdecHqx) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecHqx) SetOutputCorrupt(value bool) error {
...
func (e *AvdecHqx) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecHqx) SetSkipFrame(value interface{}) error {
...
func (e *AvdecHqx) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecHqx) SetThreadType(value interface{}) error {
