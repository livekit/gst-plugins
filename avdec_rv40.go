...
type AvdecRv40 struct {
	Element *gst.Element
}

func NewAvdecRv40() (*AvdecRv40, error) {
	e, err := gst.NewElement("avdec_rv40")
	if err != nil {
		return nil, err
	}
	return &AvdecRv40{Element: e}, nil
}

func NewAvdecRv40WithName(name string) (*AvdecRv40, error) {
	e, err := gst.NewElementWithName("avdec_rv40", name)
	if err != nil {
		return nil, err
	}
	return &AvdecRv40{Element: e}, nil
...
func (e *AvdecRv40) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecRv40) SetDebugMv(value bool) error {
...
func (e *AvdecRv40) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecRv40) SetDirectRendering(value bool) error {
...
func (e *AvdecRv40) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecRv40) SetLowres(value interface{}) error {
...
func (e *AvdecRv40) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecRv40) SetMaxThreads(value int) error {
...
func (e *AvdecRv40) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecRv40) SetOutputCorrupt(value bool) error {
...
func (e *AvdecRv40) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecRv40) SetSkipFrame(value interface{}) error {
...
func (e *AvdecRv40) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecRv40) SetThreadType(value interface{}) error {
