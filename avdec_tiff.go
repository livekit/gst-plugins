...
type AvdecTiff struct {
	Element *gst.Element
}

func NewAvdecTiff() (*AvdecTiff, error) {
	e, err := gst.NewElement("avdec_tiff")
	if err != nil {
		return nil, err
	}
	return &AvdecTiff{Element: e}, nil
}

func NewAvdecTiffWithName(name string) (*AvdecTiff, error) {
	e, err := gst.NewElementWithName("avdec_tiff", name)
	if err != nil {
		return nil, err
	}
	return &AvdecTiff{Element: e}, nil
...
func (e *AvdecTiff) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecTiff) SetDebugMv(value bool) error {
...
func (e *AvdecTiff) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecTiff) SetDirectRendering(value bool) error {
...
func (e *AvdecTiff) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecTiff) SetLowres(value interface{}) error {
...
func (e *AvdecTiff) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecTiff) SetMaxThreads(value int) error {
...
func (e *AvdecTiff) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecTiff) SetOutputCorrupt(value bool) error {
...
func (e *AvdecTiff) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecTiff) SetSkipFrame(value interface{}) error {
...
func (e *AvdecTiff) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecTiff) SetThreadType(value interface{}) error {
