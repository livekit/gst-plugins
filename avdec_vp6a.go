...
type AvdecVp6A struct {
	Element *gst.Element
}

func NewAvdecVp6A() (*AvdecVp6A, error) {
	e, err := gst.NewElement("avdec_vp6a")
	if err != nil {
		return nil, err
	}
	return &AvdecVp6A{Element: e}, nil
}

func NewAvdecVp6AWithName(name string) (*AvdecVp6A, error) {
	e, err := gst.NewElementWithName("avdec_vp6a", name)
	if err != nil {
		return nil, err
	}
	return &AvdecVp6A{Element: e}, nil
...
func (e *AvdecVp6A) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecVp6A) SetDebugMv(value bool) error {
...
func (e *AvdecVp6A) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecVp6A) SetDirectRendering(value bool) error {
...
func (e *AvdecVp6A) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecVp6A) SetLowres(value interface{}) error {
...
func (e *AvdecVp6A) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecVp6A) SetMaxThreads(value int) error {
...
func (e *AvdecVp6A) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecVp6A) SetOutputCorrupt(value bool) error {
...
func (e *AvdecVp6A) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecVp6A) SetSkipFrame(value interface{}) error {
...
func (e *AvdecVp6A) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecVp6A) SetThreadType(value interface{}) error {
