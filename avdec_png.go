...
type AvdecPng struct {
	Element *gst.Element
}

func NewAvdecPng() (*AvdecPng, error) {
	e, err := gst.NewElement("avdec_png")
	if err != nil {
		return nil, err
	}
	return &AvdecPng{Element: e}, nil
}

func NewAvdecPngWithName(name string) (*AvdecPng, error) {
	e, err := gst.NewElementWithName("avdec_png", name)
	if err != nil {
		return nil, err
	}
	return &AvdecPng{Element: e}, nil
...
func (e *AvdecPng) GetDebugMv() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecPng) SetDebugMv(value bool) error {
...
func (e *AvdecPng) GetDirectRendering() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecPng) SetDirectRendering(value bool) error {
...
func (e *AvdecPng) GetLowres() (interface{}, error) {
	return e.Element.GetProperty("lowres")
}

func (e *AvdecPng) SetLowres(value interface{}) error {
...
func (e *AvdecPng) GetMaxThreads() (int, error) {
	var value int
	var ok bool
...
func (e *AvdecPng) SetMaxThreads(value int) error {
...
func (e *AvdecPng) GetOutputCorrupt() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvdecPng) SetOutputCorrupt(value bool) error {
...
func (e *AvdecPng) GetSkipFrame() (interface{}, error) {
	return e.Element.GetProperty("skip-frame")
}

func (e *AvdecPng) SetSkipFrame(value interface{}) error {
...
func (e *AvdecPng) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvdecPng) SetThreadType(value interface{}) error {
