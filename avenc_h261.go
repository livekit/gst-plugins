...
type AvencH261 struct {
	Element *gst.Element
}

func NewAvencH261() (*AvencH261, error) {
	e, err := gst.NewElement("avenc_h261")
	if err != nil {
		return nil, err
	}
	return &AvencH261{Element: e}, nil
}

func NewAvencH261WithName(name string) (*AvencH261, error) {
	e, err := gst.NewElementWithName("avenc_h261", name)
	if err != nil {
		return nil, err
	}
	return &AvencH261{Element: e}, nil
...
func (e *AvencH261) GetA53Cc() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencH261) SetA53Cc(value bool) error {
...
func (e *AvencH261) GetBQfactor() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencH261) SetBQfactor(value float32) error {
...
func (e *AvencH261) GetBQoffset() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencH261) SetBQoffset(value float32) error {
...
func (e *AvencH261) GetBSensitivity() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetBSensitivity(value int) error {
...
func (e *AvencH261) GetBStrategy() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetBStrategy(value int) error {
...
func (e *AvencH261) GetBidirRefine() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetBidirRefine(value int) error {
...
func (e *AvencH261) GetBitrate() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetBitrate(value int) error {
...
func (e *AvencH261) GetBitrateTolerance() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetBitrateTolerance(value int) error {
...
func (e *AvencH261) GetBorderMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencH261) SetBorderMask(value float32) error {
...
func (e *AvencH261) GetBrdScale() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetBrdScale(value int) error {
...
func (e *AvencH261) GetBufsize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetBufsize(value int) error {
...
func (e *AvencH261) GetChromaElimThreshold() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetChromaElimThreshold(value int) error {
...
func (e *AvencH261) GetChromaSampleLocation() (interface{}, error) {
	return e.Element.GetProperty("chroma-sample-location")
}

func (e *AvencH261) SetChromaSampleLocation(value interface{}) error {
...
func (e *AvencH261) GetChromaoffset() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetChromaoffset(value int) error {
...
func (e *AvencH261) GetCmp() (interface{}, error) {
	return e.Element.GetProperty("cmp")
}

func (e *AvencH261) SetCmp(value interface{}) error {
...
func (e *AvencH261) GetCoder() (interface{}, error) {
	return e.Element.GetProperty("coder")
}

func (e *AvencH261) SetCoder(value interface{}) error {
...
func (e *AvencH261) GetCompressionLevel() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetCompressionLevel(value int) error {
...
func (e *AvencH261) GetContext() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetContext(value int) error {
...
func (e *AvencH261) GetDarkMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencH261) SetDarkMask(value float32) error {
...
func (e *AvencH261) GetDc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetDc(value int) error {
...
func (e *AvencH261) GetDct() (interface{}, error) {
	return e.Element.GetProperty("dct")
}

func (e *AvencH261) SetDct(value interface{}) error {
...
func (e *AvencH261) GetDebug() (interface{}, error) {
	return e.Element.GetProperty("debug")
}

func (e *AvencH261) SetDebug(value interface{}) error {
...
func (e *AvencH261) GetDiaSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetDiaSize(value int) error {
...
func (e *AvencH261) GetDumpSeparator() (string, error) {
	var value string
	var ok bool
...
func (e *AvencH261) SetDumpSeparator(value string) error {
...
func (e *AvencH261) GetErrDetect() (interface{}, error) {
	return e.Element.GetProperty("err-detect")
}

func (e *AvencH261) SetErrDetect(value interface{}) error {
...
func (e *AvencH261) GetErrorRate() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetErrorRate(value int) error {
...
func (e *AvencH261) GetExportSideData() (interface{}, error) {
	return e.Element.GetProperty("export-side-data")
}

func (e *AvencH261) SetExportSideData(value interface{}) error {
...
func (e *AvencH261) GetFieldOrder() (interface{}, error) {
	return e.Element.GetProperty("field-order")
}

func (e *AvencH261) SetFieldOrder(value interface{}) error {
...
func (e *AvencH261) GetFlags() (interface{}, error) {
	return e.Element.GetProperty("flags")
}

func (e *AvencH261) SetFlags(value interface{}) error {
...
func (e *AvencH261) GetFlags2() (interface{}, error) {
	return e.Element.GetProperty("flags2")
}

func (e *AvencH261) SetFlags2(value interface{}) error {
...
func (e *AvencH261) GetForceDuplicatedMatrix() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencH261) SetForceDuplicatedMatrix(value bool) error {
...
func (e *AvencH261) GetGlobalQuality() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetGlobalQuality(value int) error {
...
func (e *AvencH261) GetGopSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetGopSize(value int) error {
...
func (e *AvencH261) GetIQfactor() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencH261) SetIQfactor(value float32) error {
...
func (e *AvencH261) GetIQoffset() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencH261) SetIQoffset(value float32) error {
...
func (e *AvencH261) GetIbias() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetIbias(value int) error {
...
func (e *AvencH261) GetIdct() (interface{}, error) {
	return e.Element.GetProperty("idct")
}

func (e *AvencH261) SetIdct(value interface{}) error {
...
func (e *AvencH261) GetIldctcmp() (interface{}, error) {
	return e.Element.GetProperty("ildctcmp")
}

func (e *AvencH261) SetIldctcmp(value interface{}) error {
...
func (e *AvencH261) GetIntraPenalty() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetIntraPenalty(value int) error {
...
func (e *AvencH261) GetKeyintMin() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetKeyintMin(value int) error {
...
func (e *AvencH261) GetLastPred() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetLastPred(value int) error {
...
func (e *AvencH261) GetLmax() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetLmax(value int) error {
...
func (e *AvencH261) GetLmin() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetLmin(value int) error {
...
func (e *AvencH261) GetLumaElimThreshold() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetLumaElimThreshold(value int) error {
...
func (e *AvencH261) GetLumiMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencH261) SetLumiMask(value float32) error {
...
func (e *AvencH261) GetMaxBframes() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetMaxBframes(value int) error {
...
func (e *AvencH261) GetMaxPixels() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencH261) SetMaxPixels(value int64) error {
...
func (e *AvencH261) GetMaxrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencH261) SetMaxrate(value int64) error {
...
func (e *AvencH261) GetMbcmp() (interface{}, error) {
	return e.Element.GetProperty("mbcmp")
}

func (e *AvencH261) SetMbcmp(value interface{}) error {
...
func (e *AvencH261) GetMbd() (interface{}, error) {
	return e.Element.GetProperty("mbd")
}

func (e *AvencH261) SetMbd(value interface{}) error {
...
func (e *AvencH261) GetMblmax() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetMblmax(value int) error {
...
func (e *AvencH261) GetMblmin() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetMblmin(value int) error {
...
func (e *AvencH261) GetMeRange() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetMeRange(value int) error {
...
func (e *AvencH261) GetMepc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetMepc(value int) error {
...
func (e *AvencH261) GetMepre() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetMepre(value int) error {
...
func (e *AvencH261) GetMinrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencH261) SetMinrate(value int64) error {
	return e.Element.SetProperty("minrate", value)
}

// motion-est (GstH261EncoderMotionEst)
//
// motion estimation algorithm (Private codec option)

func (e *AvencH261) GetMotionEst() (interface{}, error) {
	return e.Element.GetProperty("motion-est")
}

func (e *AvencH261) SetMotionEst(value interface{}) error {
...
func (e *AvencH261) GetMpegQuant() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetMpegQuant(value int) error {
	return e.Element.SetProperty("mpeg-quant", value)
}

// mpv-flags (GstH261EncoderMpvFlags)
//
// Flags common for all mpegvideo-based encoders. (Private codec option)

func (e *AvencH261) GetMpvFlags() (interface{}, error) {
	return e.Element.GetProperty("mpv-flags")
}

func (e *AvencH261) SetMpvFlags(value interface{}) error {
...
func (e *AvencH261) GetMultipassCacheFile() (string, error) {
	var value string
	var ok bool
...
func (e *AvencH261) SetMultipassCacheFile(value string) error {
...
func (e *AvencH261) GetMv0Threshold() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetMv0Threshold(value int) error {
...
func (e *AvencH261) GetNoiseReduction() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetNoiseReduction(value int) error {
...
func (e *AvencH261) GetNr() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetNr(value int) error {
...
func (e *AvencH261) GetNssew() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetNssew(value int) error {
...
func (e *AvencH261) GetPMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencH261) SetPMask(value float32) error {
...
func (e *AvencH261) GetPass() (interface{}, error) {
	return e.Element.GetProperty("pass")
}

func (e *AvencH261) SetPass(value interface{}) error {
...
func (e *AvencH261) GetPbias() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetPbias(value int) error {
...
func (e *AvencH261) GetPreDiaSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetPreDiaSize(value int) error {
...
func (e *AvencH261) GetPrecmp() (interface{}, error) {
	return e.Element.GetProperty("precmp")
}

func (e *AvencH261) SetPrecmp(value interface{}) error {
...
func (e *AvencH261) GetPred() (interface{}, error) {
	return e.Element.GetProperty("pred")
}

func (e *AvencH261) SetPred(value interface{}) error {
...
func (e *AvencH261) GetPreme() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetPreme(value int) error {
...
func (e *AvencH261) GetPs() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetPs(value int) error {
...
func (e *AvencH261) GetQblur() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencH261) SetQblur(value float32) error {
...
func (e *AvencH261) GetQcomp() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencH261) SetQcomp(value float32) error {
...
func (e *AvencH261) GetQdiff() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetQdiff(value int) error {
...
func (e *AvencH261) GetQmax() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetQmax(value int) error {
...
func (e *AvencH261) GetQmin() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetQmin(value int) error {
...
func (e *AvencH261) GetQsquish() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencH261) SetQsquish(value float32) error {
...
func (e *AvencH261) GetQuantizer() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencH261) SetQuantizer(value float32) error {
...
func (e *AvencH261) GetQuantizerNoiseShaping() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetQuantizerNoiseShaping(value int) error {
...
func (e *AvencH261) GetRcBufAggressivity() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencH261) SetRcBufAggressivity(value float32) error {
...
func (e *AvencH261) GetRcEq() (string, error) {
	var value string
	var ok bool
...
func (e *AvencH261) SetRcEq(value string) error {
...
func (e *AvencH261) GetRcInitCplx() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencH261) SetRcInitCplx(value float32) error {
...
func (e *AvencH261) GetRcInitOccupancy() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetRcInitOccupancy(value int) error {
...
func (e *AvencH261) GetRcMaxVbvUse() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencH261) SetRcMaxVbvUse(value float32) error {
...
func (e *AvencH261) GetRcMinVbvUse() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencH261) SetRcMinVbvUse(value float32) error {
...
func (e *AvencH261) GetRcQmodAmp() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencH261) SetRcQmodAmp(value float32) error {
...
func (e *AvencH261) GetRcQmodFreq() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetRcQmodFreq(value int) error {
	return e.Element.SetProperty("rc-qmod-freq", value)
}

// rc-strategy (GstH261EncoderRcStrategy)
//
// ratecontrol method (Private codec option)

func (e *AvencH261) GetRcStrategy() (interface{}, error) {
	return e.Element.GetProperty("rc-strategy")
}

func (e *AvencH261) SetRcStrategy(value interface{}) error {
...
func (e *AvencH261) GetRefs() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetRefs(value int) error {
...
func (e *AvencH261) GetScThreshold() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetScThreshold(value int) error {
...
func (e *AvencH261) GetScplxMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencH261) SetScplxMask(value float32) error {
...
func (e *AvencH261) GetSideDataOnlyPackets() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencH261) SetSideDataOnlyPackets(value bool) error {
	return e.Element.SetProperty("side-data-only-packets", value)
}

// skip-cmp (GstH261EncoderCmpFunc)
//
// Frame skip compare function (Private codec option)

func (e *AvencH261) GetSkipCmp() (interface{}, error) {
	return e.Element.GetProperty("skip-cmp")
}

func (e *AvencH261) SetSkipCmp(value interface{}) error {
...
func (e *AvencH261) GetSkipExp() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetSkipExp(value int) error {
...
func (e *AvencH261) GetSkipFactor() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetSkipFactor(value int) error {
...
func (e *AvencH261) GetSkipThreshold() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetSkipThreshold(value int) error {
...
func (e *AvencH261) GetSlices() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetSlices(value int) error {
...
func (e *AvencH261) GetStrict() (interface{}, error) {
	return e.Element.GetProperty("strict")
}

func (e *AvencH261) SetStrict(value interface{}) error {
...
func (e *AvencH261) GetSubcmp() (interface{}, error) {
	return e.Element.GetProperty("subcmp")
}

func (e *AvencH261) SetSubcmp(value interface{}) error {
...
func (e *AvencH261) GetSubq() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetSubq(value int) error {
...
func (e *AvencH261) GetTcplxMask() (float32, error) {
	var value float32
	var ok bool
...
func (e *AvencH261) SetTcplxMask(value float32) error {
...
func (e *AvencH261) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvencH261) SetThreadType(value interface{}) error {
...
func (e *AvencH261) GetThreads() (interface{}, error) {
	return e.Element.GetProperty("threads")
}

func (e *AvencH261) SetThreads(value interface{}) error {
...
func (e *AvencH261) GetTicksPerFrame() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetTicksPerFrame(value int) error {
...
func (e *AvencH261) GetTimecodeFrameStart() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencH261) SetTimecodeFrameStart(value int64) error {
...
func (e *AvencH261) GetTrellis() (int, error) {
	var value int
	var ok bool
...
func (e *AvencH261) SetTrellis(value int) error {
	return e.Element.SetProperty("trellis", value)
}

// ----- Constants -----

type H261EncoderCmpFunc string

const (
	H261EncoderCmpFuncSad H261EncoderCmpFunc = "sad" // sad (0) – Sum of absolute differences, fast
	H261EncoderCmpFuncSse H261EncoderCmpFunc = "sse" // sse (1) – Sum of squared errors
	H261EncoderCmpFuncSatd H261EncoderCmpFunc = "satd" // satd (2) – Sum of absolute Hadamard transformed differences
	H261EncoderCmpFuncDct H261EncoderCmpFunc = "dct" // dct (3) – Sum of absolute DCT transformed differences
	H261EncoderCmpFuncPsnr H261EncoderCmpFunc = "psnr" // psnr (4) – Sum of squared quantization errors, low quality
	H261EncoderCmpFuncBit H261EncoderCmpFunc = "bit" // bit (5) – Number of bits needed for the block
	H261EncoderCmpFuncRd H261EncoderCmpFunc = "rd" // rd (6) – Rate distortion optimal, slow
	H261EncoderCmpFuncZero H261EncoderCmpFunc = "zero" // zero (7) – Zero
	H261EncoderCmpFuncVsad H261EncoderCmpFunc = "vsad" // vsad (8) – Sum of absolute vertical differences
	H261EncoderCmpFuncVsse H261EncoderCmpFunc = "vsse" // vsse (9) – Sum of squared vertical differences
	H261EncoderCmpFuncNsse H261EncoderCmpFunc = "nsse" // nsse (10) – Noise preserving sum of squared differences
	H261EncoderCmpFuncDctmax H261EncoderCmpFunc = "dctmax" // dctmax (13) – dctmax
	H261EncoderCmpFuncDct264 H261EncoderCmpFunc = "dct264" // dct264 (14) – dct264
	H261EncoderCmpFuncMsad H261EncoderCmpFunc = "msad" // msad (15) – Sum of absolute differences, median predicted
	H261EncoderCmpFuncChroma H261EncoderCmpFunc = "chroma" // chroma (256) – chroma
)

type H261EncoderMotionEst string

const (
	H261EncoderMotionEstZero H261EncoderMotionEst = "zero" // zero (0) – zero
	H261EncoderMotionEstEpzs H261EncoderMotionEst = "epzs" // epzs (1) – epzs
	H261EncoderMotionEstXone H261EncoderMotionEst = "xone" // xone (2) – xone
)

type H261EncoderMpvFlags string

const (
	H261EncoderMpvFlagsSkipRd H261EncoderMpvFlags = "skip_rd" // skip_rd (0x00000001) – RD optimal MB level residual skipping
	H261EncoderMpvFlagsStrictGop H261EncoderMpvFlags = "strict_gop" // strict_gop (0x00000002) – Strictly enforce gop size
	H261EncoderMpvFlagsQpRd H261EncoderMpvFlags = "qp_rd" // qp_rd (0x00000004) – Use rate distortion optimization for qp selection
	H261EncoderMpvFlagsCbpRd H261EncoderMpvFlags = "cbp_rd" // cbp_rd (0x00000008) – use rate distortion optimization for CBP
	H261EncoderMpvFlagsNaq H261EncoderMpvFlags = "naq" // naq (0x00000010) – normalize adaptive quantization
	H261EncoderMpvFlagsMv0 H261EncoderMpvFlags = "mv0" // mv0 (0x00000020) – always try a mb with mv=<0,0>
)

type H261EncoderRcStrategy string

const (
	H261EncoderRcStrategyFfmpeg H261EncoderRcStrategy = "ffmpeg" // ffmpeg (0) – deprecated, does nothing
)
