...
type AvencAdpcmImaAlp struct {
	Element *gst.Element
}

func NewAvencAdpcmImaAlp() (*AvencAdpcmImaAlp, error) {
	e, err := gst.NewElement("avenc_adpcm_ima_alp")
	if err != nil {
		return nil, err
	}
	return &AvencAdpcmImaAlp{Element: e}, nil
}

func NewAvencAdpcmImaAlpWithName(name string) (*AvencAdpcmImaAlp, error) {
	e, err := gst.NewElementWithName("avenc_adpcm_ima_alp", name)
	if err != nil {
		return nil, err
	}
	return &AvencAdpcmImaAlp{Element: e}, nil
...
func (e *AvencAdpcmImaAlp) GetAc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaAlp) SetAc(value int) error {
...
func (e *AvencAdpcmImaAlp) GetAr() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaAlp) SetAr(value int) error {
...
func (e *AvencAdpcmImaAlp) GetAudioServiceType() (interface{}, error) {
	return e.Element.GetProperty("audio-service-type")
}

func (e *AvencAdpcmImaAlp) SetAudioServiceType(value interface{}) error {
...
func (e *AvencAdpcmImaAlp) GetBitrate() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaAlp) SetBitrate(value int) error {
...
func (e *AvencAdpcmImaAlp) GetBlockSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaAlp) SetBlockSize(value int) error {
...
func (e *AvencAdpcmImaAlp) GetBufsize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaAlp) SetBufsize(value int) error {
...
func (e *AvencAdpcmImaAlp) GetChannelLayout() (uint64, error) {
	var value uint64
	var ok bool
...
func (e *AvencAdpcmImaAlp) SetChannelLayout(value uint64) error {
...
func (e *AvencAdpcmImaAlp) GetCompressionLevel() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaAlp) SetCompressionLevel(value int) error {
...
func (e *AvencAdpcmImaAlp) GetCutoff() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaAlp) SetCutoff(value int) error {
...
func (e *AvencAdpcmImaAlp) GetDebug() (interface{}, error) {
	return e.Element.GetProperty("debug")
}

func (e *AvencAdpcmImaAlp) SetDebug(value interface{}) error {
...
func (e *AvencAdpcmImaAlp) GetDumpSeparator() (string, error) {
	var value string
	var ok bool
...
func (e *AvencAdpcmImaAlp) SetDumpSeparator(value string) error {
...
func (e *AvencAdpcmImaAlp) GetErrDetect() (interface{}, error) {
	return e.Element.GetProperty("err-detect")
}

func (e *AvencAdpcmImaAlp) SetErrDetect(value interface{}) error {
...
func (e *AvencAdpcmImaAlp) GetExportSideData() (interface{}, error) {
	return e.Element.GetProperty("export-side-data")
}

func (e *AvencAdpcmImaAlp) SetExportSideData(value interface{}) error {
...
func (e *AvencAdpcmImaAlp) GetFlags() (interface{}, error) {
	return e.Element.GetProperty("flags")
}

func (e *AvencAdpcmImaAlp) SetFlags(value interface{}) error {
...
func (e *AvencAdpcmImaAlp) GetFlags2() (interface{}, error) {
	return e.Element.GetProperty("flags2")
}

func (e *AvencAdpcmImaAlp) SetFlags2(value interface{}) error {
...
func (e *AvencAdpcmImaAlp) GetFrameSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaAlp) SetFrameSize(value int) error {
...
func (e *AvencAdpcmImaAlp) GetGlobalQuality() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaAlp) SetGlobalQuality(value int) error {
...
func (e *AvencAdpcmImaAlp) GetMaxPixels() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAdpcmImaAlp) SetMaxPixels(value int64) error {
...
func (e *AvencAdpcmImaAlp) GetMaxPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaAlp) SetMaxPredictionOrder(value int) error {
...
func (e *AvencAdpcmImaAlp) GetMaxSamples() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAdpcmImaAlp) SetMaxSamples(value int64) error {
...
func (e *AvencAdpcmImaAlp) GetMaxrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAdpcmImaAlp) SetMaxrate(value int64) error {
...
func (e *AvencAdpcmImaAlp) GetMinPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaAlp) SetMinPredictionOrder(value int) error {
...
func (e *AvencAdpcmImaAlp) GetMinrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencAdpcmImaAlp) SetMinrate(value int64) error {
...
func (e *AvencAdpcmImaAlp) GetSideDataOnlyPackets() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencAdpcmImaAlp) SetSideDataOnlyPackets(value bool) error {
...
func (e *AvencAdpcmImaAlp) GetStrict() (interface{}, error) {
	return e.Element.GetProperty("strict")
}

func (e *AvencAdpcmImaAlp) SetStrict(value interface{}) error {
...
func (e *AvencAdpcmImaAlp) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvencAdpcmImaAlp) SetThreadType(value interface{}) error {
...
func (e *AvencAdpcmImaAlp) GetThreads() (interface{}, error) {
	return e.Element.GetProperty("threads")
}

func (e *AvencAdpcmImaAlp) SetThreads(value interface{}) error {
...
func (e *AvencAdpcmImaAlp) GetTicksPerFrame() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaAlp) SetTicksPerFrame(value int) error {
...
func (e *AvencAdpcmImaAlp) GetTrellis() (int, error) {
	var value int
	var ok bool
...
func (e *AvencAdpcmImaAlp) SetTrellis(value int) error {
