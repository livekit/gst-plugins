...
type AvencOpus struct {
	Element *gst.Element
}

func NewAvencOpus() (*AvencOpus, error) {
	e, err := gst.NewElement("avenc_opus")
	if err != nil {
		return nil, err
	}
	return &AvencOpus{Element: e}, nil
}

func NewAvencOpusWithName(name string) (*AvencOpus, error) {
	e, err := gst.NewElementWithName("avenc_opus", name)
	if err != nil {
		return nil, err
	}
	return &AvencOpus{Element: e}, nil
...
func (e *AvencOpus) GetAc() (int, error) {
	var value int
	var ok bool
...
func (e *AvencOpus) SetAc(value int) error {
	return e.Element.SetProperty("ac", value)
}

// apply-phase-inv (bool)
//
// Apply intensity stereo phase inversion (Private codec option)

func (e *AvencOpus) GetApplyPhaseInv() (bool, error) {
	var value bool
	var ok bool
	v, err := e.Element.GetProperty("apply-phase-inv")
	if err != nil {
		return value, err
	}
	value, ok = v.(bool)
...
func (e *AvencOpus) SetApplyPhaseInv(value bool) error {
	return e.Element.SetProperty("apply-phase-inv", value)
}
...
func (e *AvencOpus) GetAr() (int, error) {
	var value int
	var ok bool
...
func (e *AvencOpus) SetAr(value int) error {
...
func (e *AvencOpus) GetAudioServiceType() (interface{}, error) {
	return e.Element.GetProperty("audio-service-type")
}

func (e *AvencOpus) SetAudioServiceType(value interface{}) error {
...
func (e *AvencOpus) GetBitrate() (int, error) {
	var value int
	var ok bool
...
func (e *AvencOpus) SetBitrate(value int) error {
...
func (e *AvencOpus) GetBufsize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencOpus) SetBufsize(value int) error {
...
func (e *AvencOpus) GetChannelLayout() (uint64, error) {
	var value uint64
	var ok bool
...
func (e *AvencOpus) SetChannelLayout(value uint64) error {
...
func (e *AvencOpus) GetCompressionLevel() (int, error) {
	var value int
	var ok bool
...
func (e *AvencOpus) SetCompressionLevel(value int) error {
...
func (e *AvencOpus) GetCutoff() (int, error) {
	var value int
	var ok bool
...
func (e *AvencOpus) SetCutoff(value int) error {
...
func (e *AvencOpus) GetDebug() (interface{}, error) {
	return e.Element.GetProperty("debug")
}

func (e *AvencOpus) SetDebug(value interface{}) error {
...
func (e *AvencOpus) GetDumpSeparator() (string, error) {
	var value string
	var ok bool
...
func (e *AvencOpus) SetDumpSeparator(value string) error {
...
func (e *AvencOpus) GetErrDetect() (interface{}, error) {
	return e.Element.GetProperty("err-detect")
}

func (e *AvencOpus) SetErrDetect(value interface{}) error {
...
func (e *AvencOpus) GetExportSideData() (interface{}, error) {
	return e.Element.GetProperty("export-side-data")
}

func (e *AvencOpus) SetExportSideData(value interface{}) error {
...
func (e *AvencOpus) GetFlags() (interface{}, error) {
	return e.Element.GetProperty("flags")
}

func (e *AvencOpus) SetFlags(value interface{}) error {
...
func (e *AvencOpus) GetFlags2() (interface{}, error) {
	return e.Element.GetProperty("flags2")
}

func (e *AvencOpus) SetFlags2(value interface{}) error {
...
func (e *AvencOpus) GetFrameSize() (int, error) {
	var value int
	var ok bool
...
func (e *AvencOpus) SetFrameSize(value int) error {
...
func (e *AvencOpus) GetGlobalQuality() (int, error) {
	var value int
	var ok bool
...
func (e *AvencOpus) SetGlobalQuality(value int) error {
...
func (e *AvencOpus) GetMaxPixels() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencOpus) SetMaxPixels(value int64) error {
...
func (e *AvencOpus) GetMaxPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencOpus) SetMaxPredictionOrder(value int) error {
...
func (e *AvencOpus) GetMaxSamples() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencOpus) SetMaxSamples(value int64) error {
...
func (e *AvencOpus) GetMaxrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencOpus) SetMaxrate(value int64) error {
...
func (e *AvencOpus) GetMinPredictionOrder() (int, error) {
	var value int
	var ok bool
...
func (e *AvencOpus) SetMinPredictionOrder(value int) error {
...
func (e *AvencOpus) GetMinrate() (int64, error) {
	var value int64
	var ok bool
...
func (e *AvencOpus) SetMinrate(value int64) error {
	return e.Element.SetProperty("minrate", value)
}

// opus-delay (float32)
//
// Maximum delay in milliseconds (Private codec option)

func (e *AvencOpus) GetOpusDelay() (float32, error) {
	var value float32
	var ok bool
	v, err := e.Element.GetProperty("opus-delay")
	if err != nil {
		return value, err
	}
	value, ok = v.(float32)
...
func (e *AvencOpus) SetOpusDelay(value float32) error {
	return e.Element.SetProperty("opus-delay", value)
}
...
func (e *AvencOpus) GetSideDataOnlyPackets() (bool, error) {
	var value bool
	var ok bool
...
func (e *AvencOpus) SetSideDataOnlyPackets(value bool) error {
...
func (e *AvencOpus) GetStrict() (interface{}, error) {
	return e.Element.GetProperty("strict")
}

func (e *AvencOpus) SetStrict(value interface{}) error {
...
func (e *AvencOpus) GetThreadType() (interface{}, error) {
	return e.Element.GetProperty("thread-type")
}

func (e *AvencOpus) SetThreadType(value interface{}) error {
...
func (e *AvencOpus) GetThreads() (interface{}, error) {
	return e.Element.GetProperty("threads")
}

func (e *AvencOpus) SetThreads(value interface{}) error {
...
func (e *AvencOpus) GetTicksPerFrame() (int, error) {
	var value int
	var ok bool
...
func (e *AvencOpus) SetTicksPerFrame(value int) error {
...
func (e *AvencOpus) GetTrellis() (int, error) {
	var value int
	var ok bool
...
func (e *AvencOpus) SetTrellis(value int) error {
