...
func NewIsmlmux() (*Ismlmux, error) {
	e, err := gst.NewElement("ismlmux")
	if err != nil {
		return nil, err
	}
	return &Ismlmux{GstAggregator: &base.GstAggregator{Element: e}}, nil
}

func NewIsmlmuxWithName(name string) (*Ismlmux, error) {
...
func (e *Ismlmux) GetStreamable() (bool, error) {
	var value bool
	var ok bool
...
func (e *Ismlmux) SetStreamable(value bool) error {
